...
(function () {
    ...
    function Y(a, b, c) {
        var d, e;
        if (Qa(b))t(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (t(b) &&
            ga(b))for (d in b)a.setAttribute(d, b[d]);
        return e
    }
    ...
    function K(a, b) {
        if (Ja && !da && b && b.opacity !== r)b.filter = "alpha(opacity=" + b.opacity * 100 + ")";
        s(a.style, b)
    }
    ...
    function aa(a, b, c, d, e) {
        a = D.createElement(a);
        b && s(a, b);
        e && K(a, {padding: 0, border: $, margin: 0});
        c && K(a, c);
        d && d.appendChild(a);
        return a
    }
    ...
    function Ka(a, b, c, d) {
        var e = F.lang, a = +a || 0, f = b === -1 ? (a.toString().split(".")[1] || "").length : isNaN(b = P(b)) ? 2 : b, b = c === void 0 ? e.decimalPoint : c, d = d === void 0 ? e.thousandsSep : d, e = a < 0 ? "-" : "", c = String(G(a = P(a).toFixed(f))), g = c.length > 3 ? c.length % 3 : 0;
    ...
    function La(a, b) {
        for (var c = "{", d = !1, e, f, g, h, i, j = []; (c = a.indexOf(c)) !== -1;) {
            ...
            if (d) {
                ...
                if (f.length)f = f.join(":"), g = /\.([0-9])/, h = F.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = Ka(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = wa(f, e)
            }
            j.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    function Lb() {
        var a = F.global.useUTC, b = a ? "getUTC" : "get", c = a ? "setUTC" : "set";
        Na = (a && F.global.timezoneOffset || 0) * 6E4;
        kb = a ? Date.UTC : function (a, b, c, g, h, i) {
    ...
    var r, D = document, S = window, X = Math, u = X.round, V = X.floor, Xa = X.ceil, v = X.max, A = X.min, P = X.abs, ea = X.cos, ja = X.sin, ta = X.PI, Oa = ta * 2 / 360, Fa = navigator.userAgent, Rb = S.opera, Ja = /msie/i.test(Fa) && !Rb, nb = D.documentMode === 8, Db = /AppleWebKit/.test(Fa), bb = /Firefox/.test(Fa), eb = /(Mobile|Android|Windows Phone)/.test(Fa), Ga = "http://www.w3.org/2000/svg", da = !!D.createElementNS && !!D.createElementNS(Ga, "svg").createSVGRect, Xb = bb && parseInt(Fa.split("Firefox/")[1],
        10) < 4, ka = !da && !Ja && !!D.createElement("canvas").getContext, Ya, cb, Sb = {}, Eb = 0, jb, F, wa, Ea, Fb, H, oa, pa = function () {
        return r
    }, ba = [], fb = 0, Va = "div", $ = "none", Yb = /^[0-9]+$/, Zb = "stroke-width", kb, Na, xb, yb, zb, Wa, lb, mb, Mb, Nb, Ab, Ob, Pb, B = {}, Q;
    S.Highcharts ? oa(16, !0) : Q = S.Highcharts = {};
    wa = function (a, b, c) {
        if (!t(b) || isNaN(b))return"Invalid date";
        var a = q(a, "%Y-%m-%d %H:%M:%S"), d = new Date(b - Na), e, f = d[yb](), g = d[zb](), h = d[Wa](), i = d[lb](), j = d[mb](), k = F.lang, l = k.weekdays, d = s({a: l[g].substr(0, 3), A: l[g], d: Sa(h), e: h, b: k.shortMonths[i],
            B: k.months[i], m: Sa(i + 1), y: j.toString().substr(2, 2), Y: j, H: Sa(f), I: Sa(f % 12 || 12), l: f % 12 || 12, M: Sa(d[xb]()), p: f < 12 ? "AM" : "PM", P: f < 12 ? "am" : "pm", S: Sa(d.getSeconds()), L: Sa(u(b % 1E3), 3)}, Q.dateFormats);
    ...
    H = {millisecond: 1, second: 1E3, minute: 6E4, hour: 36E5,
        day: 864E5, week: 6048E5, month: 26784E5, year: 31556952E3};
    Fb = {init: function (a, b, c) {
    ...
    (function (a) {
        S.HighchartsAdapter = S.HighchartsAdapter || a && {init: function (b) {
            ...
            a.each(["cur",
                ...
                (k = e[b]) && (e[b] = function (c) {
                    var d, c = a ? c : this;
                    if (c.prop !== "align")return d = c.elem, d.attr ? d.attr(c.prop, b === "cur" ? r : c.now) : k.apply(this, arguments)
                })
            });
            M(e, "get", function (a, b, c) {
            ...
            a.fn.highcharts = function () {
                ...
                if (this[0]) {
                    Qa(b[0]) && (a = b[0], b = Array.prototype.slice.call(b, 1));
                    c = b[0];
                    if (c !== r)c.chart = c.chart || {}, c.chart.renderTo = this[0], new Q[a](c, b[1]), d = this;
                    c === r && (d = ba[Y(this[0], "data-highcharts-chart")])
                }
                return d
            }
            ...
            !Ja && d && (delete d.layerX, delete d.layerY, delete d.returnValue);
            s(f, d);
            b[c] && (b[g] = b[c],
                b[c] = null);
    ...
    var E = S.HighchartsAdapter, T = E || {};
    E && E.init.call(E, Fb);
    var ob = T.adapterRun, $b = T.getScript, ya = T.inArray, p = T.each, pb = T.grep, ac = T.offset, za = T.map, z = T.addEvent, U = T.removeEvent, N = T.fireEvent, bc = T.washMouseEvent, qb = T.animate, gb = T.stop, T = {enabled: !0, x: 0, y: 15, style: {color: "#eeeeee", cursor: "default", fontSize: "11px"}};
    F = {colors: "#FF0000,#434348,#90ed7d,#f7a35c,#8085e9,#f15c80,#e4d354,#8085e8,#8d4653,#91e8e1".split(","), symbols: ["circle", "diamond", "square", "triangle", "triangle-down"], lang: {loading: "Loading...",
        ...
        chart: {borderColor: "#4572A7", borderRadius: 0, defaultSeriesType: "line", ignoreHiddenSeries: !0, spacing: [10, 10, 15, 10], backgroundColor: "#000000", plotBorderColor: "#C0C0C0", resetZoomButton: {theme: {zIndex: 20}, position: {align: "right", x: -10, y: 10}}}, title: {text: "Chart title", align: "center", margin: 15, style: {color: "#333333", fontSize: "18px"}}, subtitle: {text: "", align: "center", style: {color: "#555555"}}, plotOptions: {line: {allowPointSelect: !1, showCheckbox: !1, animation: {duration: 1E3}, events: {}, lineWidth: 2, marker: {lineWidth: 0,
            radius: 4, lineColor: "#FFFFFF", states: {hover: {enabled: !0, lineWidthPlus: 1, radiusPlus: 2}, select: {fillColor: "#FFFFFF", lineColor: "#000000", lineWidth: 2}}}, point: {events: {}}, dataLabels: x(T, {align: "center", enabled: !1, formatter: function () {
            return this.y === null ? "" : Ka(this.y, -1)
        }, verticalAlign: "bottom", y: 0}), cropThreshold: 300, pointRange: 0, states: {hover: {lineWidthPlus: 1, marker: {}, halo: {size: 10, opacity: 0.25}}, select: {marker: {}}}, stickyTracking: !0, turboThreshold: 1E3}}, labels: {style: {position: "absolute", color: "#3E576F"}},
        legend: {enabled: !0, align: "center", layout: "horizontal", labelFormatter: function () {
            return this.name
            ...
            pointFormat: '<span style="color:{series.color}">●</span> {series.name}: <b>{point.y}</b><br/>', shadow: !0, snap: eb ? 25 : 10, style: {color: "#333333", cursor: "default", fontSize: "12px", padding: "8px", whiteSpace: "nowrap"}}, credits: {enabled: !0, text: "TR4DEST4R.COM", href: "http://www.tr4dest4r.com", position: {align: "left", x: 20, verticalAlign: "bottom", y: -30}, style: {cursor: "pointer", color: "#ccc", fontSize: "10px"}}};
    var W = F.plotOptions, E = W.line;
    Lb();
    var cc = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/,
        dc = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/, ec = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/, Ha = function (a) {
            ...
            (function (a) {
                a && a.stops ? d = za(a.stops, function (a) {
                    return Ha(a[1])
                }) : (c = cc.exec(a)) ? b = [G(c[1]), G(c[2]), G(c[3]), parseFloat(c[4], 10)] : (c = dc.exec(a)) ? b = [G(c[1], 16), G(c[2], 16), G(c[3], 16), 1] : (c = ec.exec(a)) && (b = [G(c[1]), G(c[2]), G(c[3]), 1])
            })(a);
    ...
    Z.prototype = {opacity: 1, textProps: "fontSize,fontWeight,fontFamily,color,lineHeight,width,textDecoration,textShadow,HcTextStroke".split(","), init: function (a, b) {
        this.element =
            b === "span" ? aa(b) : D.createElementNS(Ga, b);
        this.renderer = a
        ...
        if (f) {
            ...
            j = a.stops;
            m = c.radialReference;
            Ra(g) && (a[f] = g = {x1: g[0], y1: g[1], x2: g[2], y2: g[3], gradientUnits: "userSpaceOnUse"});
            f === "radialGradient" && m && !t(g.gradientUnits) && (g = x(g, {cx: m[0] - m[2] / 2 + g.cx * m[2], cy: m[1] - m[2] / 2 + g.cy * m[2], r: g.r * m[2], gradientUnits: "userSpaceOnUse"}));
            for (n in g)n !== "id" && o.push(n, g[n]);
            for (n in j)o.push(j[n]);
            o = o.join(",");
            h[o] ? a = h[o].attr("id") : (g.id = a = "highcharts-" + Eb++, h[o] = i = d.createElement(f).attr(g).add(d.defs), i.stops = [], p(j, function (a) {
                a[1].indexOf("rgba") === 0 ? (e = Ha(a[1]), k = e.get("rgb"), l = e.get("a")) : (k = a[1], l = 1);
        ...
        if (e) {
            e = this.textWidth = a && a.width && d.nodeName.toLowerCase() === "text" && G(a.width);
            b && (a = s(b, c));
            this.styles = a;
            e && (ka || !da && this.renderer.forExport) && delete a.width;
            if (Ja && !da)K(this.element, a); else {
                b = function (a, b) {
        ...
        cb && a === "click" ? (d.ontouchstart = function (a) {
            ...
            (Fa.indexOf("Android") === -1 || Date.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a)
        }) : d["on" + a] = b;
        return this
        ...
        (t(c) || t(d)) && a.push("scale(" + q(c, 1) + " " + q(d, 1) + ")");
        ...
        f = e.alignedObjects;
        if (a) {
            if (this.alignOptions = a, this.alignByTranslate = b, !c || Qa(c))this.alignTo = d = c || "renderer", sa(f, this), f.push(this), c = null
        ...
        c = this.element;
        var f = this.styles, g = e * Oa;
        d = this.textStr;
        var h;
        if (d === "" || Yb.test(d))h = "num." + d.toString().length + (f ? "|" + f.fontSize + "|" + f.fontFamily : "");
        h && (a = b.cache[h]);
        if (!a) {
            ...
            if (b.isSVG) {
                c = a.width;
                d = a.height;
                if (Ja && f && f.fontSize === "11px" && d.toPrecision(3) === "16.9")a.height = d = 14;
                if (e)a.width = P(d * ja(g)) + P(c * ea(g)), a.height = P(d * ea(g)) + P(c * ja(g))
            }
            this.bBox = a;
            h && (b.cache[h] = a)
        }
        ...
        return a && this.element.namespaceURI === Ga ? (this.element.removeAttribute("visibility"), this) : this.attr({visibility: a ? "inherit" : "visible"})
    }, hide: function () {
        ...
        if (f)c.handleZ = !0, f = G(f);
        if (c.handleZ) {
            a = d.childNodes;
            for (g = 0; g < a.length; g++)if (b = a[g], c = Y(b, "zIndex"), b !== e && (G(c) > f || !t(f) && t(c))) {
                d.insertBefore(e, b);
                h = !0;
                break
            }
        ...
        for (c && p(c, function (b) {
            ...
            d = b;
        a.alignTo && sa(a.renderer.alignedObjects, a);
        ...
        if (a) {
            ...
            for (e = 1; e <= i; e++) {
                f = g.cloneNode(0);
                h = i * 2 + 1 - 2 * e;
                Y(f, {isShadow: "true", stroke: a.color || "black", "stroke-opacity": j * e, "stroke-width": h, transform: "translate" + k, fill: $});
        ...
        if (a = a && a.toLowerCase()) {
            a =
                a.replace("shortdashdotdot", "3,1,1,1,1,1,").replace("shortdashdot", "3,1,1,1").replace("shortdot", "1,1,").replace("shortdash", "3,1,").replace("longdash", "8,3,").replace(/dot/g, "1,3,").replace("dash", "4,3,").replace(/,$/, "").replace("solid", 1).split(",");
        ...
        b || (b = D.createElementNS(Ga, "title"), this.element.appendChild(b));
        b.textContent = a
    ...
    Z.prototype["stroke-widthSetter"] = Z.prototype.strokeSetter = function (a, b, c) {
        this[b] = a;
        if (this.stroke && this["stroke-width"])this.strokeWidth = this["stroke-width"], Z.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width",
            this["stroke-width"]), this.hasStroke = !0; else if (b === "stroke-width" && a === 0 && this.hasStroke)c.removeAttribute("stroke"), this.hasStroke = !1
    };
    var la = function () {
        this.init.apply(this, arguments)
    };
    la.prototype = {Element: Z, init: function (a, b, c, d, e) {
        var f = location, g, d = this.createElement("svg").attr({version: "1.1"}).css(this.getStyle(d));
        g = d.element;
        a.appendChild(g);
        a.innerHTML.indexOf("xmlns") === -1 && Y(g, "xmlns", Ga);
        this.isSVG = !0;
        this.box = g;
        this.boxWrapper = d;
        this.alignedObjects = [];
        this.url = (bb || Db) && D.getElementsByTagName("base").length ?
            f.href.replace(/#.*?$/, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
        this.createElement("desc").add().element.appendChild(D.createTextNode("Created with Highstock 2.0.3"));
        ...
        buildText: function (a) {
            for (var b = a.element, c = this, d = c.forExport, e = q(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, j = Y(b, "x"), k = a.styles, l = a.textWidth, m = k && k.lineHeight, n = k && k.HcTextStroke, o = g.length, y = function (a) {
                return m ? G(m) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : k && k.fontSize || c.style.fontSize || 12, a).h
            }; o--;)b.removeChild(g[o]);
            !f && !n && e.indexOf(" ") === -1 ? b.appendChild(D.createTextNode(e)) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, l && !a.added && this.box.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), p(e, function (e, f) {
                var g, m = 0, e = e.replace(/<span/g, "|||<span").replace(/<\/span>/g, "</span>|||");
                g = e.split("|||");
                p(g, function (e) {
                    if (e !== "" || g.length === 1) {
                        var n = {}, o = D.createElementNS(Ga, "tspan"), I;
                        h.test(e) && (I = e.match(h)[1].replace(/(;| |^)color([ :])/,
                            "$1fill$2"), Y(o, "style", I));
                        i.test(e) && !d && (Y(o, "onclick", 'location.href="' + e.match(i)[1] + '"'), K(o, {cursor: "pointer"}));
            ...
            var j =
                this.label(a, b, c, i, null, null, null, null, "button"), k = 0, l, m, n, o, y, I, a = {x1: 0, y1: 0, x2: 0, y2: 1}, e = x({"stroke-width": 1, stroke: "#CCCCCC", fill: {linearGradient: a, stops: [
                [0, "#FEFEFE"],
                [1, "#F6F6F6"]
            ...
            I = h.style;
            delete h.style;
            z(j.element, Ja ? "mouseover" : "mouseenter", function () {
                k !== 3 && j.attr(f).css(o)
            });
            z(j.element, Ja ? "mouseout" : "mouseleave", function () {
                k !== 3 && (l = [e, f, g][k], m = [n, o, y][k], j.attr(l).css(m))
            });
            j.setState = function (a) {
                (j.state = k = a) ? a === 2 ? j.attr(g).css(y) : a === 3 && j.attr(h).css(I) : j.attr(e).css(n)
            };
            ...
            var b =
            {fill: $};
            Ra(a) ? b.d = a : ga(a) && s(b, a);
            return this.createElement("path").attr(b)
        }, circle: function (a, b, c) {
            a = ga(a) ? a : {x: a, y: b, r: c};
            ...
            var e = ga(a) ? a.r :
                e, g = this.createElement("rect"), a = ga(a) ? a : a === r ? {} : {x: a, y: b, width: v(c, 0), height: v(d, 0)};
            ...
            }, j = a.match(i)[1], a = Sb[j], g = this.image(j).attr({x: b, y: c}), g.isImg = !0, a ? k(g, a) : (g.attr({width: 0, height: 0}), aa("img", {onload: function () {
            ...
            var f = e.start, c = e.r || c || d, g = e.end - 0.001, d = e.innerR, h = e.open, i = ea(f), j = ja(f), k = ea(g), g = ja(g), e = e.end - f < ta ? 0 : 1;
            ...
            var e = "highcharts-" + Eb++, f = this.createElement("clipPath").attr({id: e}).add(this.defs), a = this.rect(a, b, c, d, 0).add(f);
            a.id = e;
            a.clipPath = f;
            return a
        }, text: function (a, b, c, d) {
            var e = ka || !da && this.forExport, f = {};
            ...
            if (!d)a.xSetter = function (a, b, c) {
                ...
                for (m = 0; m < d.length; m++)e =
                    d[m], e.getAttribute(b) === f && e.setAttribute(b, a);
                c.setAttribute(b, a)
            };
            return a
            ...
            var a = /px/.test(a) ? G(a) : /em/.test(a) ? parseFloat(a) * 12 : 12, c = a < 24 ? a + 4 : u(a * 1.2), d = u(c * 0.8);
            return{h: c, b: d, f: a}
        }, label: function (a, b, c, d, e, f, g, h, i) {
            function j() {
                var a, b;
                a = o.element.style;
                I = (v === void 0 || Gb === void 0 || n.styles.textAlign) && o.textStr && o.getBBox();
                n.width = (v || I.width || 0) + 2 * w + db;
                n.height = (Gb ||
                    I.height || 0) + 2 * w;
                R = w + m.fontMetrics(a && a.fontSize, o).b;
                if (z) {
                    if (!y)a = u(-q * w), b = h ? -R : 0, n.box = y = d ? m.symbol(d, a, b, n.width, n.height, C) : m.rect(a, b, n.width, n.height, 0, C[Zb]), y.attr("fill", $).add(n);
                    y.isImg || y.attr(s({width: u(n.width), height: u(n.height)}, C));
                    C = null
                }
            }

            function k() {
                var a = n.styles, a = a && a.textAlign, b = db + w * (1 - q), c;
                c = h ? 0 : R;
                if (t(v) && I && (a === "center" || a === "right"))b += {center: 0.5, right: 1}[a] * (v - I.width);
            ...
            var m = this, n = m.g(i), o = m.text("", 0, 0, g).attr({zIndex: 1}), y, I, q = 0, w = 3, db = 0, v, Gb, O, Hb, A = 0, C = {}, R, z;
            n.onAdd = function () {
                o.add(n);
                n.attr({text: a || "", x: b, y: c});
                y && t(e) && n.attr({anchorX: e, anchorY: f})
            };
            ...
            return s(n, {css: function (a) {
                ...
                return{width: I.width + 2 * w, height: I.height + 2 * w, x: I.x - w, y: I.y - w}
            }, shadow: function (a) {
                y && y.shadow(a);
                return n
            }, destroy: function () {
    ...
    Ya = la;
    s(Z.prototype, {htmlCss: function (a) {
        var b = this.element;
        ...
        if (this.added) {
            ...
            if (b.tagName === "SPAN") {
                var j = this.rotation, k, l = G(this.textWidth), m = [j, g, b.innerHTML, this.textWidth].join(",");
                if (m !== this.cTT) {
                    k = a.fontMetrics(b.style.fontSize).b;
                    t(j) && this.setSpanRotation(j, h, k);
                    i = q(this.elemWidth, b.offsetWidth);
                    if (i > l && /[ \-]/.test(b.textContent || b.innerText))K(b, {width: l + "px", display: "block", whiteSpace: "normal"}), i = l;
                    this.getSpanCorrection(i, k, h, j, g)
                }
                K(b, {left: e + (this.xCorr || 0) + "px", top: f + (this.yCorr || 0) + "px"});
                if (Db)k = b.offsetHeight;
                this.cTT = m
            }
        } else this.alignOnAdd = !0
    }, setSpanRotation: function (a, b, c) {
        var d = {}, e = Ja ? "-ms-transform" : Db ? "-webkit-transform" : bb ? "MozTransform" : Rb ? "-o-transform" : "";
        d[e] = d.transform = "rotate(" + a + "deg)";
        d[e + (bb ? "Origin" : "-origin")] = d.transformOrigin = b * 100 + "% " + c + "px";
        K(this.element, d)
    }, getSpanCorrection: function (a, b, c) {
        this.xCorr = -a * c;
        this.yCorr = -b
    }});
    s(la.prototype, {html: function (a, b, c) {
            ...
            if (this.parentGroup = a) {
                if (b = a.div, !b) {
                    ...
                    p(j.reverse(), function (a) {
                        var d;
                        b = a.div = a.div || aa(Va, {className: Y(a.element,
                            "class")}, {position: "absolute", left: (a.translateX || 0) + "px", top: (a.translateY || 0) + "px"}, b || c);
                        d = b.style;
                        s(a, {translateXSetter: function (b, c) {
                            d.left = b + "px";
                            a[c] = b;
                            a.doTransform = !0
    ...
    if (!da && !ka)fa = {init: function (a, b) {
        ...
        setSpanRotation: function () {
            var a = this.rotation, b = ea(a * Oa), c = ja(a * Oa);
            K(this.element, {filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", b, ", M12=", -c, ", M21=", c, ", M22=", b, ", sizingMethod='auto expand')"].join("") : $})
        }, getSpanCorrection: function (a, b, c, d, e) {
            var f = d ? ea(d * Oa) : 1, g = d ? ja(d * Oa) : 0, h = q(this.elemHeight, this.element.offsetHeight), i;
            this.xCorr = f < 0 && -a;
            this.yCorr = g < 0 && -h;
            i = f * g < 0;
            ...
            for (var b = a.length, c = []; b--;)if (ma(a[b]))c[b] = u(a[b] * 10) - 5; else if (a[b] === "Z")c[b] = "x"; else if (c[b] = a[b], a.isArc && (a[b] === "wa" || a[b] === "at"))c[b + 5] === c[b + 7] && (c[b + 7] += a[b + 7] > a[b + 5] ? 1 : -1), c[b + 6] === c[b + 8] && (c[b + 8] += a[b + 8] > a[b + 6] ? 1 : -1);
            return c.join(" ") || "x"
        }, clip: function (a) {
            var b = this, c;
            a ? (c = a.members, sa(c, b), c.push(b), b.destroyClip = function () {
                sa(c, b)
            ...
            if (a) {
                ...
                for (e = 1; e <= 3; e++) {
                    ...
                    h = aa(g.prepVML(j), null, {left: G(i.left) + q(a.offsetX, 1), top: G(i.top) + q(a.offsetY, 1)});
                    if (c)h.cutOff = l + 1;
            ...
            return this
        }, updateShadows: pa, setAttr: function (a, b) {
            ...
            var d = c.nodeName;
            if (d === "SPAN")c.style.color = a; else if (d !== "IMG")c.filled = a !== $, this.setAttr("fillcolor", this.renderer.color(a, c, b, this))
        }, opacitySetter: pa, rotationSetter: function (a, b, c) {
            c = c.style;
            this[b] = c[b] = a;
            c.left = -u(ja(a * Oa) + 1) + "px";
            c.top = u(ea(a * Oa)) + "px"
        ...
        ha(Z, fa), fa.prototype.ySetter = fa.prototype.widthSetter = fa.prototype.heightSetter = fa.prototype.xSetter, fa = {Element: fa, isIE8: Fa.indexOf("MSIE 8.0") > -1, init: function (a, b, c, d) {
        var e;
        this.alignedObjects = [];
        d = this.createElement(Va).css(s(this.getStyle(d), {position: "relative"}));
        e = d.element;
        ...
        return s(e, {members: [], left: (f ? a.x : a) + 1, top: (f ? a.y : b) + 1, width: (f ? a.width : c) - 1, height: (f ? a.height : d) - 1, getCSS: function (a) {
            ...
            !a && nb && c === "DIV" && s(d, {width: b + "px", height: f + "px"});
            return d
        ...
        if (i) {
            ...
            r[0] < 1 && a.push([1, r[1]]);
            p(a, function (a, b) {
                g.test(a[1]) ? (f = Ha(a[1]), k = f.get("rgb"), l = f.get("a")) : (k = a[1], l = 1);
                u.push(a[0] * 100 + "% " + k);
                b ? (y = l, I = k) : (o = l, q = k)
            });
            if (c === "fill")if (i === "gradient")c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, w = 'angle="' + (90 - X.atan((m - a) / (n - c)) * 180 / ta) + '"', v(); else {
                var j = m.r, t = j * 2, s = j * 2, x = m.cx, C = m.cy, R = b.radialReference, A, j = function () {
                    R && (A = d.getBBox(), x += (R[0] - A.x) / A.width -
                        0.5, C += (R[1] - A.y) / A.height - 0.5, t *= R[2] / A.width, s *= R[2] / A.height);
                    w = 'src="' + F.global.VMLRadialGradientURL + '" size="' + t + "," + s + '" origin="0.5,0.5" position="' + x + "," + C + '" color2="' + q + '" ';
                    v()
                };
                d.added ? j() : d.onAdd = j;
                j = I
            } else j = k
        } else if (g.test(a) && b.tagName !== "IMG")f = Ha(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], aa(this.prepVML(h), null, null, b), j = f.get("rgb"); else {
        ...
        K(a, {flip: "x", left: G(d.width) - (e ? G(e.top) :
            1), top: G(d.height) - (e ? G(e.left) : 1), rotation: -90});
        p(a.childNodes, function (b) {
            c.invertChild(b, a)
        })
    }, symbols: {arc: function (a, b, c, d, e) {
        var f = e.start, g = e.end, h = e.r || c || d, c = e.innerR, d = ea(f), i = ja(f), j = ea(g), k = ja(g);
        if (g - f === 0)return["x"];
        ...
        return la.prototype.symbols[!t(e) || !e.r ? "square" : "callout"].call(0, a, b, c, d, e)
    }}}, Q.VMLRenderer = hb = function () {
        this.init.apply(this, arguments)
    }, hb.prototype = x(la.prototype, fa), Ya = hb;
    la.prototype.measureSpanWidth = function (a, b) {
        var c = D.createElement("span"), d;
    ...
    var Ub;
    if (ka)Q.CanVGRenderer = fa = function () {
        Ga = "http://www.w3.org/1999/xhtml"
    }, fa.prototype.symbols = {},
        Ub = function () {
            function a() {
                var a = b.length, d;
                for (d = 0; d < a; d++)b[d]();
    ...
    ab.prototype = {addLabel: function () {
        ...
        this.isFirst = k;
        this.isLast = l;
        b = a.labelFormatter.call({axis: a, chart: c, isFirst: k, isLast: l, dateTimeLabelFormat: m, value: a.isLog ? ia(ra(f)) : f});
        g = d && {width: v(1, u(d - 2 * (h.padding || 10))) + "px"};
        g = s(g, h.style);
        if (t(e))e && e.attr({text: b}).css(g); else {
            m = {align: a.labelAlign};
            if (ma(i))m.rotation = i;
            if (d && h.ellipsis)g.HcHeight = a.len / j.length;
            this.label = e = t(b) && h.enabled ? c.renderer.text(b, 0, 0, h.useHTML).attr(m).css(g).add(a.labelGroup) : null;
            a.tickBaseline =
                c.renderer.fontMetrics(h.style.fontSize, e).b;
            i && a.side === 2 && (a.tickBaseline *= ea(i * Oa))
        }
        ...
        var c = !0, d = this.axis,
            e = this.isFirst, f = this.isLast, g = d.horiz ? b.x : b.y, h = d.reversed, i = d.tickPositions, j = this.getLabelSides(), k = j[0], j = j[1], l, m, n, o = this.label.line || 0;
        l = d.labelEdge;
        m = d.justifyLabels && (e || f);
        l[o] === r || g + k > l[o] ? l[o] = g + j : m || (c = !1);
        if (m) {
        ...
        getPosition: function (a, b, c, d) {
            ...
            var d = this.axis, e = d.options, f = d.chart.renderer, g = d.horiz, h = this.type, i = this.label, j = this.pos, k = e.labels, l = this.gridLine, m = h ? h + "Grid" : "grid", n = h ? h + "Tick" : "tick", o = e[m + "LineWidth"], y = e[m + "LineColor"], I = e[m + "LineDashStyle"], p = e[n + "Length"], m = e[n + "Width"] || 0, w = e[n + "Color"], db = e[n + "Position"], n = this.mark, u = k.step, v = !0, t = d.tickmarkOffset, s =
                this.getPosition(g, j, t, b), x = s.x, s = s.y, C = g && x === d.pos + d.len || !g && s === d.pos ? -1 : 1, c = q(c, 1);
            this.isActive = !0;
            if (o) {
                j = d.getPlotLinePath(j + t, o * C, b, !0);
                if (l === r) {
                    l = {stroke: y, "stroke-width": o};
                    if (I)l.dashstyle = I;
                    if (!h)l.zIndex = 1;
                    if (b)l.opacity = 0;
            ...
            if (m && p)db === "inside" && (p = -p), d.opposite && (p = -p), h = this.getMarkPath(x, s, p, m * C, g, f), n ? n.animate({d: h, opacity: c}) : this.mark = f.path(h).attr({stroke: w,
                "stroke-width": m, opacity: c}).add(d.axisGroup);
            if (i && !isNaN(x))i.xy = s = this.getLabelPosition(x, s, i, g, k, t, a, u), this.isFirst && !this.isLast && !q(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !q(e.showLastLabel, 1) ? v = !1 : !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && (v = this.handleOverflow(a, s)), u && a % u && (v = !1), v && !isNaN(s.y) ? (s.opacity = c, i[this.isNew ? "attr" : "animate"](s), this.isNew = !1) : i.attr("y", -9999)
        }, destroy: function () {
            Ma(this, this.axis)
        }};
    ...
    Q.PlotLineOrBand.prototype = {render: function () {
        var a = this, b = a.axis, c = b.horiz, d = (b.pointRange || 0) / 2, e = a.options, f = e.label, g = a.label, h = e.width, i = e.to, j = e.from, k = t(j) && t(i), l = e.value, m = e.dashStyle, n = a.svgElem, o = [], y, q = e.color, p = e.zIndex, w = e.events, r = {}, u = b.chart.renderer;
        b.isLog && (j = Ia(j), i = Ia(i), l = Ia(l));
        if (h) {
        ...
        } else if (o && o.length && (a.svgElem = n = u.path(o).attr(r).add(), w))for (y in d = function (b) {
            n.on(b, function (c) {
                w[b].apply(a, [c])
            })
        }, w)d(y);
        if (f && t(f.text) && o && o.length && b.width > 0 && b.height > 0) {
            ...
            o = Ta(b);
            c = Ta(k);
            g.align(f, !1, {x: o, y: c, width: Da(b) - o, height: Da(k) - c});
            g.show()
        } else g && g.hide();
        return a
    }, destroy: function () {
        sa(this.axis.plotLinesAndBands, this);
        delete this.axis;
        Ma(this)
    }};
    J.prototype = {defaultOptions: {dateTimeLabelFormats: {millisecond: "%H:%M:%S.%L", second: "%H:%M:%S", minute: "%H:%M", hour: "%H:%M", day: "%e. %b", week: "%e. %b",
        month: "%b '%y", year: "%Y"}, endOnTick: !1, gridLineColor: "#242424", labels: T, lineColor: "#555555", lineWidth: 1, minPadding: 0.01, maxPadding: 0.01, minorGridLineColor: "#E0E0E0", minorGridLineWidth: 1, minorTickColor: "#A0A0A0", minorTickLength: 2, minorTickPosition: "outside", startOfWeek: 1, startOnTick: !1, tickColor: "#555555", tickLength: 10, tickmarkPlacement: "between", tickPixelInterval: 100, tickPosition: "outside", tickWidth: 1, title: {align: "middle", style: {color: "#707070"}}, type: "linear"}, defaultYAxisOptions: {endOnTick: !0,
        gridLineWidth: 1, tickPixelInterval: 72, showLastLabel: !0, labels: {x: -8, y: 3}, lineWidth: 0, maxPadding: 0.05, minPadding: 0.05, startOnTick: !0, tickWidth: 0, title: {rotation: 270, text: "Values"}, stackLabels: {enabled: !1, formatter: function () {
            return Ka(this.total, -1)
        }, style: T.style}}, defaultLeftAxisOptions: {labels: {x: -15, y: null}, title: {rotation: 270}}, defaultRightAxisOptions: {labels: {x: 15, y: null}, title: {rotation: 90}}, defaultBottomAxisOptions: {labels: {x: 0, y: null}, title: {rotation: 0}}, defaultTopAxisOptions: {labels: {x: 0,
        y: -15}, title: {rotation: 0}}, init: function (a, b) {
        var c = b.isX;
        ...
        this.crosshair = q(d.crosshair, na(a.options.tooltip.crosshairs)[c ? 0 : 1],
            !1);
        var f, d = this.options.events;
        ya(this, a.axes) === -1 && (c && !this.isColorAxis ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this), a[this.coll].push(this));
        this.series = this.series || [];
        if (a.inverted && c && this.reversed === r)this.reversed = !0;
        this.removePlotLine = this.removePlotBand = this.removePlotBandOrLine;
        for (f in d)z(this, f, d[f]);
        if (this.isLog)this.val2lin = Ia, this.lin2val = ra
        ...
        if (h)g = La(h, this); else if (c)g = b; else if (d)g = wa(d, b); else if (f && a >= 1E3)for (; f-- && g === r;)c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = Ka(b / c, -1) + e[f]);
        g === r && (g = P(b) >= 1E4 ? Ka(b, 0) : Ka(b, -1, r, ""));
        return g
        ...
        p(a.series, function (c) {
            if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                ...
                a.isLog && d <= 0 && (d = null);
                if (a.isXAxis) {
                    if (d = c.xData, d.length)a.dataMin = A(q(a.dataMin, d[0]), Ta(d)), a.dataMax = v(q(a.dataMax, d[0]), Da(d))
                } else {
                    c.getExtremes();
                    e = c.dataMax;
                    c = c.dataMin;
                    if (t(c) && t(e))a.dataMin = A(q(a.dataMin, c), c), a.dataMax =
                        v(q(a.dataMax, e), e);
                    if (t(d))if (a.dataMin >= d)a.dataMin = d, a.ignoreMinPadding = !0; else if (a.dataMax < d)a.dataMax = d, a.ignoreMaxPadding = !0
                }
            }
        })
        ...
        b ? (a = a * g + h, a -= j, a = a / i + d, e && (a = this.lin2val(a))) : (e && (a = this.val2lin(a)), f === "between" && (f = 0.5),
            a = g * (a - d) * i + h + g * j + (ma(f) ? i * f * this.pointRange : 0));
        return a
        ...
        var d, e = ia(V(b / a) * a), f = ia(Xa(c / a) * a), g = [];
        ...
        if (this.isLog) {
            e = b.length;
            for (a = 1; a < e; a++)d = d.concat(this.getLogTickPositions(c,
                b[a - 1], b[a], !0))
        ...
        if (this.isXAxis && this.minRange === r && !this.isLog)t(a.min) || t(a.max) ? this.minRange = null : (p(this.series, function (a) {
            i =
                a.xData;
        ...
        if (b.isXAxis ||
            i || d)h ? (f = h.minPointOffset, g = h.pointRangePadding) : p(b.series, function (a) {
            var h = i ? 1 : b.isXAxis ? a.pointRange : b.axisPointRange || 0, j = a.options.pointPlacement, n = a.closestPointRange;
            h > c && (h = 0);
            d = v(d, h);
            f = v(f, Qa(j) ? 0 : h / 2);
            g = v(g, j === "on" ? 0 : h);
            !a.noSharedTooltip && t(n) && (e = t(e) ? A(e, n) : n)
        ...
        var b = this, c = b.chart, d = b.options, e = d.startOnTick, f = d.endOnTick, g = b.isLog, h = b.isDatetimeAxis, i = b.isXAxis, j = b.isLinked, k = b.options.tickPositioner, l = d.maxPadding, m = d.minPadding, n = d.tickInterval, o = d.minTickInterval, y = d.tickPixelInterval, I, qa = b.categories;
        j ? (b.linkedParent = c[b.coll][d.linkedTo], c = b.linkedParent.getExtremes(), b.min = q(c.min, c.dataMin), b.max = q(c.max, c.dataMax), d.type !== b.linkedParent.options.type && oa(11, 1)) : (b.min = q(b.userMin, d.min, b.dataMin),
            b.max = q(b.userMax, d.max, b.dataMax));
        if (g)!a && A(b.min, q(b.dataMin, b.min)) <= 0 && oa(10, 1), b.min = ia(Ia(b.min)), b.max = ia(Ia(b.max));
        if (b.range && t(b.max))b.userMin = b.min = v(b.min, b.max - b.range), b.userMax = b.max, b.range = null;
        b.beforePadding && b.beforePadding();
        b.adjustForMinRange();
        if (!qa && !b.axisPointRange && !b.usePercentage && !j && t(b.min) && t(b.max) && (c = b.max - b.min)) {
            if (!t(d.min) && !t(b.userMin) && m && (b.dataMin < 0 || !b.ignoreMinPadding))b.min -= c * m;
            if (!t(d.max) && !t(b.userMax) && l && (b.dataMax > 0 || !b.ignoreMaxPadding))b.max +=
                c * l
        }
        if (ma(d.floor))b.min = v(b.min, d.floor);
        if (ma(d.ceiling))b.max = A(b.max, d.ceiling);
        b.min === b.max || b.min === void 0 || b.max === void 0 ? b.tickInterval = 1 : j && !n && y === b.linkedParent.options.tickPixelInterval ? b.tickInterval = b.linkedParent.tickInterval : (b.tickInterval = q(n, qa ? 1 : (b.max - b.min) * y / v(b.len, y)), !t(n) && b.len < y && !this.isRadial && !this.isLog && !qa && e && f && (I = !0, b.tickInterval /= 4));
        ...
        if (!h && !g && !n)b.tickInterval = vb(b.tickInterval, null, ub(b.tickInterval), d);
        ...
        if (!a)!b.ordinalPositions &&
            (b.max - b.min) / b.tickInterval > v(2 * b.len, 200) && oa(19, !0), a = h ? b.getTimeTicks(b.normalizeTimeTickInterval(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions, b.closestPointRange, !0) : g ? b.getLogTickPositions(b.tickInterval, b.min, b.max) : b.getLinearTickPositions(b.tickInterval, b.min, b.max), I && a.splice(1, a.length - 2), b.tickPositions = a;
        if (!j)d = a[0], g = a[a.length - 1], h = b.minPointOffset || 0, !e && !f && !qa && a.length === 2 && a.splice(1, 0, (g + d) / 2), e ? b.min = d : b.min - h > d && a.shift(), f ? b.max = g : b.max + h < g && a.pop(),
        ...
        this.allowZoomOutside || (t(c) && a <= A(c, q(e.min, c)) && (a = r), t(d) && b >= v(d, q(e.max, d)) && (b = r));
        ...
        var a = this.chart, b = this.options, c = b.offsetLeft || 0, d = this.horiz, e = q(b.width,
            a.plotWidth - c + (b.offsetRight || 0)), f = q(b.height, a.plotHeight), g = q(b.top, a.plotTop), b = q(b.left, a.plotLeft + c), c = /%$/;
        ...
        var a = this.isLog;
        return{min: a ? ia(ra(this.min)) : this.min, max: a ? ia(ra(this.max)) : this.max, dataMin: this.dataMin, dataMax: this.dataMax,
            userMin: this.userMin, userMax: this.userMax}
    }, getThreshold: function (a) {
        var b = this.isLog, c = b ? ra(this.min) : this.min, b = b ? ra(this.max) : this.max;
        ...
        var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, j, k, l = 0, m, n = 0, o = d.title, y = d.labels, I = 0, qa =
            b.axisOffset, b = b.clipOffset, w = [-1, 1, 1, -1][h], u, s = 1, x = q(y.maxStaggerLines, 5), O, A, z, C, R;
        ...
        if (j || a.isLinked) {
            a.labelAlign = q(y.align ||
                a.autoLabelAlign(y.rotation));
            p(e, function (b) {
                f[b] ? f[b].addLabel() : f[b] = new ab(a, b)
            });
            if (a.horiz && !a.staggerLines && x && !y.rotation) {
                for (j = a.reversed ? [].concat(e).reverse() : e; s < x;) {
                    O = [];
                    A = !1;
                    for (u = 0; u < j.length; u++)z = j[u], C = (C = f[z].label && f[z].label.getBBox()) ? C.width : 0, R = u % s, C && (z = a.translate(z), O[R] !== r && z < O[R] && (A = !0), O[R] = z + C);
                    if (A)s++; else break
                }
                if (s > 1)a.staggerLines = s
            }
            p(e, function (b) {
                if (h === 0 || h === 2 || {1: "left", 3: "right"}[h] === a.labelAlign)I = v(f[b].getLabelSize(), I)
            });
            if (a.staggerLines)I *= a.staggerLines,
                a.labelOffset = I
        ...
        if (o && o.text && o.enabled !== !1) {
            ...
            if (k)l = a.axisTitle.getBBox()[g ? "height" : "width"], m = o.offset, n = t(m) ? 0 : q(o.margin, g ? 5 : 10);
            a.axisTitle[k ? "show" : "hide"]()
        }
        a.offset = w * q(d.offset,
            qa[h]);
        c = h === 2 ? a.tickBaseline : 0;
        g = I + n + (I && w * (g ? q(y.y, a.tickBaseline + 8) : y.x) - c);
        a.axisTitleMargin = q(m, g);
        qa[h] = v(qa[h], a.axisTitleMargin + l + w * a.offset, g);
        ...
        c && (a *= -1);
        return b.renderer.crispLine(["M", e ? this.left : (f - 14), e ? d : this.top, "L", e ? (b.chartWidth - this.right) + 7 : (f - 14), e ? d : b.chartHeight - this.bottom], a)
    }, getTitlePosition: function () {
        var a =
            this.horiz, b = this.left, c = this.top, d = this.len, e = this.options.title, f = a ? b : c, g = this.opposite, h = this.offset, i = G(e.style.fontSize || 12), d = {low: f + (a ? 0 : d), middle: f + d / 2, high: f + (a ? d : 0)}[e.align], b = (a ? c + this.height : b) + (a ? 1 : -1) * (g ? -1 : 1) * this.axisTitleMargin + (this.side === 2 ? i : 0);
        ...
        var a = this, b = a.horiz, c = a.reversed, d = a.chart, e = d.renderer, f = a.options, g = a.isLog, h = a.isLinked, i = a.tickPositions, j, k = a.axisTitle, l = a.ticks,
            m = a.minorTicks, n = a.alternateBands, o = f.stackLabels, y = f.alternateGridColor, q = a.tickmarkOffset, qa = f.lineWidth, w = d.hasRendered && t(a.oldMin) && !isNaN(a.oldMin), u = a.hasData, v = a.showAxis, s, x = f.labels.overflow, A = a.justifyLabels = b && x !== !1, z;
        a.labelEdge.length = 0;
        a.justifyToPlot = x === "justify";
        p([l, m, n], function (a) {
            for (var b in a)a[b].isActive = !1
        });
        if (u || h)if (a.minorTickInterval && !a.categories && p(a.getMinorTickPositions(), function (b) {
            m[b] || (m[b] = new ab(a, b, "minor"));
            ...
            if (!h || b >= a.min && b <= a.max)l[b] || (l[b] = new ab(a, b)), w && l[b].isNew && l[b].render(c, !0, 0.1), l[b].render(c)
        }), q && a.min === 0 && (l[-1] || (l[-1] = new ab(a, -1, null, !0)), l[-1].render(-1))), y && p(i, function (b, c) {
            if (c % 2 === 0 && b < a.max)n[b] || (n[b] = new Q.PlotLineOrBand(a)), s = b + q, z = i[c + 1] !== r ? i[c + 1] + q : a.max, n[b].options = {from: g ? ra(s) : s, to: g ? ra(z) : z, color: y}, n[b].render(), n[b].isActive = !0
        }), !a._addedPlotLB)p((f.plotLines || []).concat(f.plotBands || []), function (b) {
            a.addPlotBandOrLine(b)
        }), a._addedPlotLB = !0;
        p([l, m, n], function (a) {
            var b, c, e = [], f = Ea ? Ea.duration || 500 : 0, g = function () {
        ...
        if (qa)b = a.getLinePath(qa), a.axisLine ? a.axisLine.animate({d: b}) : a.axisLine = e.path(b).attr({stroke: f.lineColor,
            "stroke-width": qa, zIndex: 7}).add(a.axisGroup), a.axisLine[v ? "show" : "hide"]();
        ...
        if (this.crosshair)if ((t(b) || !q(this.crosshair.snap, !0)) === !1)this.hideCrosshair(); else {
            ...
            q(d.snap, !0) ? t(b) && (c = this.chart.inverted != this.horiz ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos;
            c = this.isRadial ? this.getPlotLinePath(this.isXAxis ?
                b.x : q(b.stackY, b.y)) : this.getPlotLinePath(null, null, null, null, c);
    ...
    s(J.prototype, {getPlotBandPath: function (a, b) {
        ...
        p([c.plotLines || [], d.plotLines || [], c.plotBands || [], d.plotBands || []], function (b) {
            for (e = b.length; e--;)b[e].id === a && sa(b, b[e])
        })
    }});
    J.prototype.getTimeTicks = function (a, b, c, d) {
        var e = [], f = {}, g = F.global.useUTC, h, i = new Date(b - Na), j = a.unitRange, k = a.count;
        if (t(b)) {
            j >= H.second && (i.setMilliseconds(0), i.setSeconds(j >= H.minute ? 0 : k * V(i.getSeconds() / k)));
            if (j >= H.minute)i[Mb](j >= H.hour ? 0 : k * V(i[xb]() / k));
            if (j >= H.hour)i[Nb](j >= H.day ? 0 : k * V(i[yb]() / k));
            if (j >= H.day)i[Ab](j >= H.month ? 1 : k * V(i[Wa]() / k));
            j >= H.month && (i[Ob](j >=
                H.year ? 0 : k * V(i[lb]() / k)), h = i[mb]());
            j >= H.year && (h -= h % k, i[Pb](h));
            if (j === H.week)i[Ab](i[Wa]() - i[zb]() + q(d, 1));
            b = 1;
            Na && (i = new Date(i.getTime() + Na));
            h = i[mb]();
            for (var d = i.getTime(), l = i[lb](), m = i[Wa](), n = g ? Na : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c;)e.push(d), j === H.year ? d = kb(h + b * k, 0) : j === H.month ? d = kb(h, l + b * k) : !g && (j === H.day || j === H.week) ? d = kb(h, l, m + b * k * (j === H.day ? 1 : 7)) : d += j * k, b++;
            e.push(d);
            p(pb(e, function (a) {
                return j <= H.hour && a % H.day === n
            }), function (a) {
                f[a] = "day"
            })
        }
        e.info = s(a, {higherRanks: f, totalRange: j *
            k});
        return e
    };
    J.prototype.normalizeTimeTickInterval = function (a, b) {
        ...
        c = vb(a / e, f, d[0] === "year" ? v(ub(a / e), 1) : 1);
        return{unitRange: e, count: c,
            unitName: d[0]}
    };
    J.prototype.getLogTickPositions = function (a, b, c, d) {
        var e = this.options, f = this.len, g = [];
        if (!d)this._minorAutoInterval = null;
        if (a >= 0.5)a = u(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = V(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
            i = e.length;
            for (h = 0; h < i && !l; h++)j = Ia(ra(f) * e[h]), j > b && (!d || k <= c) && k !== r && g.push(k), k > c && (l = !0), k = j
        } else if (b = ra(b), c = ra(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = q(a === "auto" ? null : a, this._minorAutoInterval,
            (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = vb(a, null, ub(a)), g = za(this.getLinearTickPositions(a, b, c), Ia), !d)this._minorAutoInterval = a / 5;
        if (!d)this.tickInterval = a;
        return g
    };
    var Ib = Q.Tooltip = function () {
        this.init.apply(this, arguments)
    };
    Ib.prototype = {init: function (a, b) {
        ...
        this.now = {x: 0, y: 0};
        this.isHidden = !0;
        this.label = a.renderer.label("", 0, 0, b.shape || "callout", null, null, b.useHTML,
            null, "tooltip").attr({padding: e, fill: b.backgroundColor, "stroke-width": c, r: b.borderRadius, zIndex: 8}).css(d).css({padding: 0}).add().attr({y: -9999});
        ...
        s(f, {x: g ? (2 * f.x + a) / 3 : a, y: g ? (f.y + b) / 2 :
        ...
        var c, d = this.chart, e =
            d.inverted, f = d.plotTop, g = 0, h = 0, i, a = na(a);
        c = a[0].tooltipPos;
        ...
        i === !1 ? this.hide() : (this.isHidden && (gb(d), d.attr("opacity", 1).show()), d.attr({text: i}), k = e.borderColor || a.color || h.color || "#606060", d.attr({stroke: k}),
            this.updatePosition({plotX: f, plotY: g, negative: a.negative, ttBelow: a.ttBelow}), this.isHidden = !1);
        N(c, "tooltipRefresh", {text: i, x: f + c.plotLeft, y: g + c.plotTop, borderColor: k})
        ...
        var b = a.series, c = b.tooltipOptions, d = c.dateTimeLabelFormats, e = c.xDateFormat, f = b.xAxis, g = f && f.options.type ===
            "datetime" && ma(a.key), c = c.headerFormat, f = f && f.closestPointRange, h;
        if (g && !e) {
            if (f)for (h in H) {
        ...
        return La(c, {point: a, series: b})
    }};
    var ua;
    cb = D.documentElement.ontouchstart !== r;
    var Za = Q.Pointer = function (a, b) {
        this.init(a, b)
    };
    Za.prototype = {init: function (a, b) {
        var c = b.chart, d = c.events, e = ka ? "" : c.zoomType, c = a.inverted, f;
        this.options = b;
        this.chart = a;
        ...
        this.pinchDown = [];
        this.lastValidTouch = {};
        if (Q.Tooltip && b.tooltip.enabled)a.tooltip = new Ib(a, b.tooltip), this.followTouchMove = b.tooltip.followTouchMove;
        this.setDOMEvents()
    }, normalize: function (a, b) {
        var c, d, a = a || window.event, a = bc(a);
        if (!a.target)a.target = a.srcElement;
        d = a.touches ? a.touches.length ? a.touches.item(0) : a.changedTouches[0] : a;
        if (!b)this.chartPosition = b = ac(this.chart.container);
        d.pageX ===
            r ? (c = v(a.x, a.clientX - b.left), d = a.y) : (c = d.pageX - b.left, d = d.pageY - b.top);
        return s(a, {chartX: u(c), chartY: u(d)})
        ...
        var b = this.chart, c = b.series, d = b.tooltip, e, f, g = b.hoverPoint, h = b.hoverSeries,
            i, j, k = b.chartWidth, l = this.getIndex(a);
        if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
            f = [];
            i = c.length;
            for (j = 0; j < i; j++)if (c[j].visible && c[j].options.enableMouseTracking !== !1 && !c[j].noSharedTooltip && c[j].singularTooltips !== !0 && c[j].tooltipPoints.length && (e = c[j].tooltipPoints[l]) && e.series)e._dist = P(l - e.clientX), k = A(k, e._dist), f.push(e);
        ...
        if (d && !this._onDocumentMouseMove)this._onDocumentMouseMove = function (a) {
            if (ba[ua])ba[ua].pointer.onDocumentMouseMove(a)
        }, z(D, "mousemove", this._onDocumentMouseMove);
        p(b.axes, function (b) {
            b.drawCrosshair(a, q(e, g))
        })
    }, reset: function (a) {
        var b = this.chart, c = b.hoverSeries, d = b.hoverPoint, e = b.tooltip, f = e && e.shared ? b.hoverPoints : d;
        (a = a && e && f) && na(f)[0].plotX ===
            r && (a = !1);
        if (a)e.refresh(f), d && d.setState(d.state, !0); else {
            if (d)d.onMouseOut();
            if (c)c.onMouseOut();
            e && e.hide();
            if (this._onDocumentMouseMove)U(D, "mousemove", this._onDocumentMouseMove), this._onDocumentMouseMove = null;
            p(b.axes, function (a) {
                a.hideCrosshair()
            });
            this.hoverX = null
        ...
        e < i ? e = i : e > i + k && (e = i + k);
        this.hasDragged =
            Math.sqrt(Math.pow(m - d, 2) + Math.pow(n - e, 2));
        if (this.hasDragged > 10) {
            ...
            this.selectionMarker && f && (d -= m, this.selectionMarker.attr({width: P(d), x: (d > 0 ? 0 : d) + m}));
            this.selectionMarker && g && (d = e - n, this.selectionMarker.attr({height: P(d), y: (d > 0 ? 0 : d) + n}));
        ...
        if (this.selectionMarker) {
            ...
            if (this.hasDragged || c)p(b.axes, function (b) {
                if (b.zoomEnabled) {
                    var c = b.horiz, e = a.type === "touchend" ? b.minPixelPadding : 0, n = b.toValue((c ? f : g) + e), c = b.toValue((c ? f + h : g + i) - e);
                    !isNaN(n) && !isNaN(c) && (d[b.coll].push({axis: b,
                        min: A(n, c), max: v(n, c)}), j = !0)
                }
            }), j && N(b, "selection", d, function (a) {
        ...
        var b = this.chart, c = b.hoverPoint,
            d = b.plotLeft, e = b.plotTop, a = this.normalize(a);
        a.cancelBubble = !0;
        b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (N(c.series, "click", s(a, {point: c})), b.hoverPoint && c.firePointEvent("click", a)) : (s(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && N(b, "click", a)))
        ...
        fb === 1 && z(D, "mouseup", a.onDocumentMouseUp);
        if (cb)b.ontouchstart = function (b) {
            a.onContainerTouchStart(b)
        }, b.ontouchmove = function (b) {
            a.onContainerTouchMove(b)
        }, fb === 1 && z(D, "touchend", a.onDocumentTouchEnd)
    }, destroy: function () {
        var a;
        U(this.chart.container, "mouseleave", this.onContainerMouseLeave);
        fb || (U(D, "mouseup", this.onDocumentMouseUp), U(D, "touchend", this.onDocumentTouchEnd));
        clearInterval(this.tooltipTimeout);
        for (a in this)this[a] = null
    }};
    s(Q.Pointer.prototype, {pinchTranslate: function (a, b, c, d, e, f) {
        ...
        c();
        b = y;
        b < w.min ? (b = w.min, x = !0) : b + o > w.max && (b = w.max - o, x = !0);
        x ? (s -= 0.8 * (s - g[j][0]), r || (t -= 0.8 * (t - g[j][1])), c()) : g[j] = [s, t];
        p || (f[j] = y - n, f[m] = o);
        f = p ? 1 / q : q;
        e[m] = o;
        e[j] = b;
        d[p ? a ? "scaleY" : "scaleX" : "scale" + k] = q;
        d["translate" + k] = f * n + (s - f * u)
    }, pinch: function (a) {
        ...
        if (a.type === "touchstart")p(f, function (a, b) {
            ...
            if (a.zoomEnabled) {
                var b = c.bounds[a.horiz ? "h" : "v"], d = a.minPixelPadding, e = a.toPixels(q(a.options.min, a.dataMin)), f = a.toPixels(q(a.options.max, a.dataMax)), g = A(e, f), e = v(e, f);
                b.min = A(a.pos, g - d);
                b.max = v(a.pos + a.len, e + d)
            }
        }); else if (d.length) {
            if (!j)b.selectionMarker =
                j = s({destroy: pa}, c.plotBox);
    ...
    if (S.PointerEvent || S.MSPointerEvent) {
        var Aa = {}, Jb = !!S.PointerEvent, fc = function () {
            var a, b = [];
            b.item = function (a) {
                return this[a]
            };
            ...
            a = a.originalEvent || a;
            if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && ba[ua])d(a), d = ba[ua].pointer, d[b]({type: c, target: a.currentTarget, preventDefault: pa, touches: fc()})
        };
        s(Za.prototype, {onContainerPointerDown: function (a) {
            Kb(a,
            ...
            Kb(a, "onContainerTouchEnd", "touchend", function (a) {
            ...
            a(D, Jb ? "pointerup" : "MSPointerUp", this.onDocumentPointerUp)
        }});
        M(Za.prototype, "init", function (a, b, c) {
            a.call(this, b, c);
            (this.hasZoom || this.followTouchMove) && K(b.container, {"-ms-touch-action": $, "touch-action": $})
        });
        M(Za.prototype, "setDOMEvents", function (a) {
            a.apply(this);
            (this.hasZoom || this.followTouchMove) && this.batchMSEvents(z)
        });
        M(Za.prototype, "destroy", function (a) {
            this.batchMSEvents(U);
            a.call(this)
        })
    }
    var rb = Q.Legend = function (a, b) {
        this.init(a, b)
    };
    rb.prototype = {init: function (a, b) {
        var c = this, d = b.itemStyle, e = q(b.padding, 8), f = b.itemMarginTop || 0;
        this.options = b;
        if (b.enabled)c.itemStyle = d, c.itemHiddenStyle = x(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.symbolWidth = q(b.symbolWidth, 16), c.pages = [], c.render(), z(c.chart, "endResize", function () {
        ...
        if (b)c = b.translateY, p(this.allItems, function (e) {
            var f = e.checkbox, g;
            f && (g = c + f.y + (a || 0) + 3, K(f, {left: b.translateX +
        ...
        var b = this.chart, c = b.renderer, d = this.options, e = d.layout ===
            "horizontal", f = this.symbolWidth, g = d.symbolPadding, h = this.itemStyle, i = this.itemHiddenStyle, j = this.padding, k = e ? q(d.itemDistance, 20) : 0, l = !d.rtl, m = d.width, n = d.itemMarginBottom || 0, o = this.itemMarginTop, y = this.initialItemX, p = a.legendItem, r = a.series && a.series.drawLegendSymbol ? a.series : a, w = r.options, w = this.createCheckboxForItem && w && w.showCheckbox, s = d.useHTML;
        if (!p) {
            a.legendGroup = c.g("legend-item").attr({zIndex: 1}).add(this.scrollGroup);
            a.legendItem = p = c.text(d.labelFormat ? La(d.labelFormat, a) : d.labelFormatter.call(a),
                l ? f + g : -g, this.baseline || 0, s).css(x(a.visible ? h : i)).attr({align: l ? "left" : "right", zIndex: 2}).add(a.legendGroup);
            if (!this.baseline)this.baseline = c.fontMetrics(h.fontSize, p).f + 3 + o, p.attr("y", this.baseline);
        ...
        if (e && this.itemX - y + f >
            (m || b.chartWidth - 2 * j - y - d.x))this.itemX = y, this.itemY += o + this.lastLineHeight + n, this.lastLineHeight = 0;
        ...
        this.offsetWidth = m || v((e ? this.itemX - y - k : f) + j, this.offsetWidth)
    }, getAllItems: function () {
        var a = [];
        p(this.chart.series, function (b) {
            var c = b.options;
            if (q(c.showInLegend, !t(c.linkedTo) ? r : !1, !0))a =
        ...
        if (l || m) {
            ...
            } else a.box = i = c.rect(0, 0, g, h, j.borderRadius, l || 0).attr({stroke: j.borderColor, "stroke-width": l || 0, fill: m || $}).add(d).shadow(j.shadow), i.isNew = !0;
            i[f ? "show" : "hide"]()
        }
        a.legendWidth =
            g;
        ...
        var b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding, g = e.maxHeight, h, i = this.clipRect, j = e.navigation, k = q(j.animation, !0), l = j.arrowSize || 12, m = this.nav, n = this.pages, o, y = this.allItems;
        e.layout === "horizontal" && (f /= 2);
        g && (f = A(f, g));
        n.length = 0;
        if (a > f && !e.useHTML) {
            this.clipHeight =
                h = v(f - 20 - this.titleHeight - this.padding, 0);
        ...
        e > d && (e = d);
        if (e > 0)b !== r && $a(b, this.chart), this.nav.attr({translateX: j,
            translateY: f + this.padding + 7 + this.titleHeight, visibility: "visible"}), this.up.attr({fill: e === 1 ? g : h}).css({cursor: e === 1 ? "default" : "pointer"}), i.attr({text: e + "/" + d}), this.down.attr({x: 18 + this.pager.getBBox().width, fill: e === d ? g : h}).css({cursor: e === d ? "default" : "pointer"}), c = -c[e - 1] + this.initialItemY, this.scrollGroup.animate({translateY: c}), this.currentPage = e, this.positionCheckboxes(c)
    }};
    T = Q.LegendSymbolMixin = {drawRectangle: function (a, b) {
        ...
        d = a.symbolWidth;
        var e = this.chart.renderer, f = this.legendGroup, a = a.baseline - u(e.fontMetrics(a.options.itemStyle.fontSize, this.legendItem).b * 0.3), g;
        if (b.lineWidth) {
    ...
    (/Trident\/7\.0/.test(Fa) || bb) && M(rb.prototype, "positionItem", function (a, b) {
    ...
    xa.prototype = {init: function (a, b) {
        ...
        if (e)for (g in e)z(f, g, e[g]);
        f.xAxis = [];
        f.yAxis = [];
        f.animation = ka ? !1 : q(d.animation, !0);
        f.pointCount = f.colorCounter = f.symbolCounter = 0;
        f.firstRender()
    }, initSeries: function (a) {
        var b = this.options.chart;
        (b = B[a.type || b.type || b.defaultSeriesType]) || oa(17, !0);
        b = new b;
        b.init(this, a);
        return b
        ...
        if (h)for (l = k; l--;)if (a =
            c[l], a.options.stacking)a.isDirty = !0;
        p(c, function (a) {
        ...
        i && (p(b, function (a) {
            ...
            if (a.isDirtyExtremes)a.isDirtyExtremes = !1, o.push(function () {
                N(a, "afterSetExtremes", s(a.eventArgs, a.getExtremes()));
                delete a.eventArgs
            });
            (j || g) &&
            a.redraw()
        ...
        var a =
            this, b = this.options, c = b.xAxis = na(b.xAxis || {}), b = b.yAxis = na(b.yAxis || {});
        p(c, function (a, b) {
            a.index = b;
            a.isX = !0
        });
        ...
        g = e.subtitle = x(e.subtitle, b), e = g;
        p([
            ["title", a, f],
            ["subtitle", b, e]
        ], function (a) {
        ...
        if (c && (c.css({width: (f.width || h) + "px"}).align(s({y: g.fontMetrics(f.style.fontSize, c).b - 3}, f), !1, "spacingBox"), !f.floating && !f.verticalAlign))b = c.getBBox().height;
        d && (d.css({width: (e.width || h) + "px"}).align(s({y: b + (f.margin - 13) + g.fontMetrics(f.style.fontSize, d).b}, e), !1, "spacingBox"), !e.floating && !e.verticalAlign && (b = Xa(b + d.getBBox().height)));
        c = this.titleOffset !== b;
        this.titleOffset = b;
        if (!this.isDirtyBox && c)this.isDirtyBox = c, this.hasRendered && q(a, !0) && this.isDirtyBox && this.redraw()
    }, getChartSize: function () {
        var a = this.options.chart, b = a.width, a = a.height, c = this.renderToClone || this.renderTo;
        if (!t(b))this.containerWidth = ob(c, "width");
        if (!t(a))this.containerHeight = ob(c, "height");
        ...
        e = "highcharts-" + Eb++;
        if (Qa(a))this.renderTo = a = D.getElementById(a);
        a || oa(13, !0);
        c = G(Y(a, "data-highcharts-chart"));
        ...
        c = this.chartWidth;
        d = this.chartHeight;
        this.container = a = aa(Va, {className: "highcharts-container" + (b.className ? " " + b.className : ""), id: e}, s({position: "relative", overflow: "hidden", width: c + "px", height: d + "px", textAlign: "left", lineHeight: "normal", zIndex: 0, "-webkit-tap-highlight-color": "rgba(0,0,0,0)"},
            b.style), this.renderToClone || a);
        this._cursor = a.style.cursor;
        this.renderer = b.forExport ? new la(a, c, d, b.style, !0) : new Ya(a, c, d, b.style);
        ...
        this.resetMargins();
        b = this.axisOffset;
        if (k && !t(d[0]))this.plotTop = v(this.plotTop, k + this.options.title.margin + a[0]);
        if (c.display && !e.floating)if (i === "right") {
            if (!t(d[1]))this.marginRight =
                v(this.marginRight, c.legendWidth - g + f + a[1])
        } else if (i === "left") {
            if (!t(d[3]))this.plotLeft = v(this.plotLeft, c.legendWidth + g + f + a[3])
        } else if (j === "top") {
            if (!t(d[0]))this.plotTop = v(this.plotTop, c.legendHeight + h + f + a[0])
        } else if (j === "bottom" && !t(d[2]))this.marginBottom = v(this.marginBottom, c.legendHeight - h + f + a[2]);
        ...
        var b = this, c = b.options.chart, d = b.renderTo, e = c.width || ob(d, "width"), f = c.height || ob(d, "height"), c = a ? a.target : S, d = function () {
            if (b.container)b.setSize(e, f, !1), b.hasUserSize = null
        };
        if (!b.hasUserSize && e && f && (c === S || c === D)) {
        ...
        if (t(a))d.chartWidth = e = v(0, u(a)), d.hasUserSize = !!e;
        if (t(b))d.chartHeight = f = v(0, u(b));
        (Ea ? qb : K)(d.container, {width: e + "px", height: f + "px"}, Ea);
        d.setChartSize(!0);
        ...
        N(d, "resize");
        Ea === !1 ? g() : setTimeout(g, Ea && Ea.duration || 500)
        ...
        b = Xa(v(d, h[3]) / 2);
        c = Xa(v(d, h[0]) / 2);
        this.clipBox = {x: b, y: c, width: V(this.plotSizeX - v(d, h[1]) / 2 - b), height: v(0, V(this.plotSizeY - v(d, h[2]) / 2 - c))};
        ...
        var a = this.options.chart, b = this.renderer, c = this.chartWidth, d = this.chartHeight, e = this.chartBackground, f = this.plotBackground, g = this.plotBorder, h = this.plotBGImage, i = a.borderWidth || 0, j = a.backgroundColor, k = a.plotBackgroundColor, l = a.plotBackgroundImage,
            m = a.plotBorderWidth || 0, n, o = this.plotLeft, y = this.plotTop, q = this.plotWidth, p = this.plotHeight, w = this.plotBox, r = this.clipRect, u = this.clipBox;
        n = i + (a.shadow ? 8 : 0);
        ...
        if (k)f ? f.animate(w) : this.plotBackground = b.rect(o, y, q, p, 0).attr({fill: k}).add().shadow(a.plotShadow);
        if (l)h ? h.animate(w) : this.plotBGImage = b.image(l, o, y, q, p).add();
        r ? r.animate({width: u.width, height: u.height}) : this.clipRect = b.clipRect(u);
        if (m)g ? g.animate(g.crisp({x: o, y: y, width: q, height: p})) : this.plotBorder = b.rect(o, y, q, p, 0, -m).attr({stroke: a.plotBorderColor, "stroke-width": m, fill: $, zIndex: 1}).add();
        this.isDirtyBox = !1
        ...
        p(["inverted", "angular", "polar"], function (g) {
            ...
            for (e = d && d.length; !f && e--;)(c = B[d[e].type]) && c.prototype[g] && (f = !0);
            a[g] = f
        })
    }, linkSeries: function () {
        ...
        p(b, function (b) {
            ...
            if (Qa(d) && (d = d === ":previous" ? a.series[b.index - 1] : a.get(d)))d.linkedSeries.push(b), b.linkedParent = d
        })
        ...
        b.items && p(b.items, function (c) {
            var d =
                s(b.style, c.style), e = G(d.left) + a.plotLeft, f = G(d.top) + a.plotTop + 12;
            delete d.left;
            delete d.top;
        ...
        if (d)d.innerHTML = "", U(d), f && Ua(d);
        for (e in a)delete a[e]
    }, isReadyToRender: function () {
        var a =
            this;
        return!da && S == S.top && D.readyState !== "complete" || ka && !S.canvg ? (ka ? Ub.push(function () {
            a.firstRender()
        ...
        if (a.isReadyToRender()) {
            ...
            a.linkSeries();
            N(a, "beforeRender");
            if (Q.Pointer)a.pointer = new Za(a, b);
            a.render();
            a.renderer.draw();
            c && c.apply(a, [a]);
        ...
        var c = b[a], c = ga(c) ? c : [c, c, c, c];
        return[q(b[a + "Top"], c[0]), q(b[a + "Right"], c[1]), q(b[a + "Bottom"], c[2]), q(b[a + "Left"], c[3])]
    }};
    xa.prototype.callbacks = [];
    fa = Q.CenteredSeriesMixin = {getCenter: function () {
        var a = this.options, b = this.chart, c = 2 * (a.slicedOffset || 0), d, e = b.plotWidth - 2 * c, f = b.plotHeight -
            2 * c, b = a.center, a = [q(b[0], "50%"), q(b[1], "50%"), a.size || "100%", a.innerSize || 0], g = A(e, f), h;
        return za(a, function (a, b) {
            h = /%$/.test(a);
            d = b < 2 || b === 2 && h;
            return(h ? [e, f, g, g][b] * G(a) / 100 : a) + (d ? c : 0)
        })
    }};
    var Ba = function () {
    };
    Ba.prototype = {init: function (a, b, c) {
        this.series = a;
        ...
        if (typeof a === "number" || a === null)b[d[0]] = a; else if (Ra(a)) {
            if (a.length > e) {
                c = typeof a[0];
        ...
        a.pointCount--;
        if (b && (this.setState(), sa(b, this), !b.length))a.hoverPoints = null;
    ...
    L.prototype = {isCartesian: !0, type: "line", pointClass: Ba, sorted: !0, requireSorting: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor", r: "radius"}, axisTypes: ["xAxis",
        ...
        c._i = f.length - 1;
        wb(f, g);
        this.yAxis && wb(this.yAxis.series, g);
        p(f, function (a, b) {
            a.index = b;
        ...
        updateParallelArrays: function (a, b) {
            ...
            var a = this.options, b = this.xIncrement, b = q(b, a.pointStart, 0);
            ...
            this.userOptions = a;
            c = x(e, c.series, a);
            this.tooltipOptions = x(F.tooltip, F.plotOptions[this.type].tooltip, b.tooltip, d.series && d.series.tooltip, d[this.type] &&
            ...
            var e = this, f = e.points, g = f && f.length || 0, h, i = e.options, j = e.chart, k = null, l = e.xAxis, m = l && !!l.categories, n = e.tooltipPoints, o = i.turboThreshold, y = this.xData, I = this.yData, u = (h = e.pointArrayMap) && h.length, a = a || [];
            h = a.length;
            b = q(b, !0);
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData)p(a, function (a, b) {
                ...
                if (o && h > o) {
                    ...
                    if (ma(k)) {
                        ...
                        for (c = 0; c < h; c++)y[c] = m, I[c] = a[c], m += i;
                        e.xIncrement = m
                    } else if (Ra(k))if (u)for (c = 0; c < h; c++)i = a[c], y[c] = i[0], I[c] = i.slice(1, u + 1); else for (c = 0; c < h; c++)i = a[c], y[c] = i[0], I[c] = i[1]; else oa(12)
            ...
            if (l && this.sorted && (!j || d > j || this.forceCrop))if (m = h.getExtremes(), n = m.min, m = m.max, b[d - 1] < n || b[0] > m)b = [], c = []; else if (b[0] < n || b[d - 1] > m)e = this.cropData(this.xData,
                this.yData, n, m), b = e.xData, c = e.yData, e = e.start, f = !0, k = b.length;
            for (a = b.length - 1; a >= 0; a--)d = b[a] - b[a - 1], !f && b[a] > n && b[a] < m && k++, d > 0 && (g === r || d < g) ? g = d : d < 0 && this.requireSorting && oa(15);
            this.cropped = f;
            this.cropStart = e;
            ...
            for (m = 0; m < g; m++)i = h + m, j ? l[m] = (new f).init(this, [d[m]].concat(na(e[m]))) : (b[i] ? k = b[i] : a[i] !== r && (b[i] = k = (new f).init(this, a[i], d[m])), l[m] = k);
            ...
            d = a.length;
            for (l = 0; l < d; l++)if (j = c[l], k = a[l], i = k !== null && k !== r && (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.cropped || (c[l + 1] || j) >= g && (c[l - 1] || j) <= h, i && j)if (i = k.length)for (; i--;)k[i] !== null && (e[f++] = k[i]); else e[f++] = k;
            this.dataMin = q(void 0,
                Ta(e));
            this.dataMax = q(void 0, Da(e))
        }, translate: function () {
            this.processedXData || this.processData();
            this.generatePoints();
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || ma(i), k = a.threshold, a = 0; a < g; a++) {
                var l = f[a], m = l.x, n = l.y, o = l.low, y = b && e.stacks[(this.negStacks && n < k ? "-" : "") + this.stackKey];
                if (e.isLog && n <= 0)l.y = n = null;
                l.plotX = c.translate(m, 0, 0, 0, 1, i, this.type === "flags");
                if (b && this.visible &&
                    y && y[m])y = y[m], n = y.points[this.index + "," + a], o = n[0], n = n[1], o === 0 && (o = q(k, e.min)), e.isLog && o <= 0 && (o = null), l.total = l.stackTotal = y.total, l.percentage = y.total && l.y / y.total * 100, l.stackY = n, y.setOffset(this.pointXOffset || 0, this.barW || 0);
            ...
            var b =
                this.chart, c = b.renderer, d;
            d = this.options.animation;
            var e = this.clipBox || b.clipBox, f = b.inverted, g;
            if (d && !ga(d))d = W[this.type].animation;
            g = ["_sharedClip", d.duration, d.easing, e.height].join(",");
            a ? (a = b[g], d = b[g + "m"], a || (b[g] = a = c.clipRect(s(e, {width: 0})), b[g + "m"] = d = c.clipRect(-99, f ? -b.plotLeft : -b.plotTop, 99, f ? b.chartWidth : b.chartHeight)), this.group.clip(a), this.markerGroup.clip(d), this.sharedClipKey = g) : ((a = b[g]) && a.animate({width: b.plotSizeX}, d), b[g + "m"] && b[g + "m"].animate({width: b.plotSizeX + 99}, d), this.animate =
                null)
            ...
            var q;
            b.marker ?
                (e.radius = e.radius || c.radius + e.radiusPlus, e.lineWidth = e.lineWidth || c.lineWidth + e.lineWidthPlus) : e.color = e.color || Ha(e.color || g).brighten(e.brightness).get();
            ...
            if (!i || g < i || k)for (; g--;) {
                ...
                if (i.options)for (q in l)t(c[l[q]]) && (k = !0);
                if (k) {
                    c = c ||
                    {};
                    k = [];
                    d = c.states || {};
                    f = d.hover = d.hover || {};
                    if (!b.marker)f.color = f.color || !i.options.color && e.color || Ha(i.color).brighten(f.brightness || e.brightness).get();
                    f = {color: i.color};
            ...
            var a = this, b = a.chart, c = /AppleWebKit\/533/.test(Fa), d, e, f = a.data || [], g, h, i;
            N(a, "destroy");
            U(a);
            p(a.axisTypes || [], function (b) {
                if (i = a[b])sa(i.series, a), i.isDirty = i.forceRedraw = !0
            });
            ...
            var a =
                this, b = this.options, c = [
                ["graph", b.lineColor || this.color]
            ], d = b.lineWidth, e = b.dashStyle, f = b.linecap !== "square", g = this.getGraphPath(), h = b.negativeColor;
            h && c.push(["graphNeg", h]);
            p(c, function (c, h) {
                var k = c[0], l = a[k];
                if (l)gb(l), l.animate({d: g}); else if (d && g.length)l = {stroke: c[1], "stroke-width": d, fill: $, zIndex: 1}, e ? l.dashstyle = e : f && (l["stroke-linecap"] = l["stroke-linejoin"] = "round"), a[k] = a.chart.renderer.path(g).attr(l).add(a.group).shadow(!h && b.shadow)
            })
        }, clipNeg: function () {
            var a = this.options, b = this.chart,
                c = b.renderer, d = a.negativeColor || a.negativeFillColor, e, f = this.graph, g = this.area, h = this.posClip, i = this.negClip;
            e = b.chartWidth;
    ...
    Qb.prototype = {destroy: function () {
        ...
        var c = this.axis, d = c.chart, e = d.inverted, f = this.isNegative, g = c.translate(c.usePercentage ? 100 : this.total, 0, 0, 0, 1), c = c.translate(0), c = P(g - c), h = d.xAxis[0].translate(this.x) + a, i = d.plotHeight, f = {x: e ? f ? g : g - c : h, y: e ? i - h - b : f ? i - g - c : i - g, width: e ? c : b, height: e ? b : c};
    ...
    J.prototype.buildStacks = function () {
        var a = this.series, b = q(this.options.reversedStacks, !0), c = a.length;
        if (!this.isXAxis) {
    ...
    J.prototype.renderStackTotals = function () {
        ...
        if (!f)this.stackTotalGroup = f = b.g("stack-labels").attr({visibility: "visible",
            zIndex: 6}).add();
        ...
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            ...
            for (p = 0; p < d; p++) {
                ...
                o = (n = j && w <
                    f) ? i : h;
                l[o] || (l[o] = {});
                if (!l[o][r])m[o] && m[o][r] ? (l[o][r] = m[o][r], l[o][r].total = null) : l[o][r] = new Qb(k, k.options.stackLabels, n, r, g);
                o = l[o][r];
                o.points[q] = [o.cum || 0];
                e === "percent" ? (n = n ? h : i, j && l[n] && l[n][r] ? (n = l[n][r], o.total = n.total = v(n.total, o.total) + P(w) || 0) : o.total = ia(o.total + (P(w) || 0))) : o.total = ia(o.total + (w || 0));
                o.cum = (o.cum || 0) + (w || 0);
    ...
    L.prototype.setPercentStacks = function () {
        var a = this,
            b = a.stackKey, c = a.yAxis.stacks, d = a.processedXData;
        p([b, "-" + b], function (b) {
            var e;
            for (var f = d.length, g, h; f--;)if (g = d[f], e = (h = c[b] && c[b][g]) && h.points[a.index + "," + f], g = e)h = h.total ? 100 / h.total : 0, g[0] = ia(g[0] * h), g[1] = ia(g[1] * h), a.stackedYData[f] = g[1]
        })
    };
    s(xa.prototype, {addSeries: function (a, b, c) {
        var d, e = this;
        a && (b = q(b, !0), N(e, "addSeries", {options: a}, function () {
            d = e.initSeries(a);
            e.isDirtyLegend = !0;
            e.linkSeries();
            b && e.redraw(c)
        ...
        new J(this, x(a, {index: this[e].length, isX: b}));
        f[e] = na(f[e] || {});
        f[e].push(a);
        q(c, !0) && this.redraw(d)
    }, showLoading: function (a) {
        var b = this, c = b.options, d = b.loadingDiv, e = c.loading, f = function () {
            d && K(d, {left: b.plotLeft + "px", top: b.plotTop + "px", width: b.plotWidth + "px", height: b.plotHeight + "px"})
        };
        if (!d)b.loadingDiv = d = aa(Va, {className: "highcharts-loading"}, s(e.style, {zIndex: 10, display: $}), b.container), b.loadingSpan = aa("span", null, e.labelStyle, d), z(b, "redraw", f);
        b.loadingSpan.innerHTML = a || c.lang.loading;
        if (!b.loadingShown)K(d,
            {opacity: 0, display: ""}), qb(d, {opacity: e.style.opacity}, {duration: e.showDuration || 0}), b.loadingShown = !0;
        f()
    }, hideLoading: function () {
        var a = this.options, b = this.loadingDiv;
        b && qb(b, {opacity: 0}, {duration: a.loading.hideDuration || 100, complete: function () {
            K(b, {display: $})
        }});
        this.loadingShown = !1
    }});
    s(Ba.prototype, {update: function (a, b, c) {
        var d = this, e = d.series, f = d.graphic, g, h = e.data, i = e.chart, j = e.options, b = q(b, !0);
    ...
    s(L.prototype, {addPoint: function (a, b, c, d) {
        ...
        b = q(b, !0);
        d = {series: this};
        this.pointClass.prototype.applyOptions.apply(d,
            [a]);
        g = d.x;
        h = n.length;
    ...
    s(J.prototype, {update: function (a, b) {
    ...
    var Ca = ha(L);
    B.line = Ca;
    W.area = x(E, {threshold: 0});
    var va = ha(L, {type: "area", getSegments: function () {
        ...
        if (this.options.stacking && !this.cropped) {
            ...
            p(d, function (b) {
                ...
                if (!l || h[b] && h[b].y !== null)if (h[b])c.push(h[b]); else {
                    ...
                    i = e.translate(b);
                    j = f.toPixels(d, !0);
                    c.push({y: null, plotX: i, clientX: i, plotY: j, yBottom: j, onMouseOver: pa})
                }
            });
            c.length && b.push(c)
        } else L.prototype.getSegments.call(this), b = this.segments;
        this.segments = b
    }, getSegmentPath: function (a) {
        ...
        if (e.stacking && !this.closedStacks)for (d = a.length - 1; d >= 0; d--)g = q(a[d].yBottom, f), d < a.length - 1 && e.step && c.push(a[d + 1].plotX, g), c.push(a[d].plotX, g); else this.closeSegment(c, a, f);
        ...
        p(f, function (d) {
            var e = d[0], f = a[e];
            f ? f.animate({d: b}) : a[e] = a.chart.renderer.path(b).attr({fill: q(d[2], Ha(d[1]).setOpacity(q(c.fillOpacity, 0.75)).get()), zIndex: 0}).add(a.group)
        })
    }, drawLegendSymbol: T.drawRectangle});
    B.area = va;
    W.spline = x(E);
    Ca = ha(L, {type: "spline", getPointSpline: function (a, b, c) {
    ...
    B.spline = Ca;
    W.areaspline = x(W.area);
    va = va.prototype;
    Ca = ha(Ca, {type: "areaspline", closedStacks: !0, getSegmentPath: va.getSegmentPath,
        closeSegment: va.closeSegment, drawGraph: va.drawGraph, drawLegendSymbol: T.drawRectangle});
    B.areaspline = Ca;
    W.column = x(E, {borderColor: "#FFFFFF", borderRadius: 0, groupPadding: 0.2, marker: null, pointPadding: 0.1, minPointLength: 0, cropThreshold: 50, pointRange: null, states: {hover: {brightness: 0.1, shadow: !1, halo: !1}, select: {color: "#C0C0C0", borderColor: "#000000", shadow: !1}}, dataLabels: {align: null, verticalAlign: null, y: null}, stickyTracking: !1, tooltip: {distance: 6}, threshold: 0});
    Ca = ha(L, {type: "column", pointAttrToOptions: {stroke: "borderColor",
        ...
        var c = A(P(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len), j = c * b.groupPadding, k = (c - 2 * j) / i, l = b.pointWidth, b = t(l) ? (k - l) / 2 : k * b.pointPadding, l = q(l, k - 2 * b);
        ...
        var a = this, b = a.chart, c = a.options, d = a.borderWidth = q(c.borderWidth, a.activePointCount > 0.5 * a.xAxis.len ? 0 : 1), e = a.yAxis,
            f = a.translatedThreshold = e.getThreshold(c.threshold), g = q(c.minPointLength, 5), h = a.getColumnMetrics(), i = h.width, j = a.barW = v(i, 1 + 2 * d), k = a.pointXOffset = h.offset, l = -(d % 2 ? 0.5 : 0), m = d % 2 ? 0.5 : 1;
        b.renderer.isVML && b.inverted && (m += 1);
        c.pointPadding && (j = Xa(j));
        ...
        p(a.points, function (c) {
            ...
            s = v(h, d) - w;
            P(s) < g && g && (s = g, w = u(P(w - f) > g ? d - g : f - (e.translate(c.y, 0, 1, 0, 1) <= f ? g : 0)));
            c.barX = p;
            c.pointWidth = i;
            c.tooltipPos =
                b.inverted ? [e.len - h, a.xAxis.len - p - r / 2] : [p + r / 2, h];
            r = u(p + r) + l;
            p = u(p) + l;
            r -= p;
            d = P(w) < 0.5;
            ...
            d && (w -= 1, s += 1);
            c.shapeType = "rect";
            c.shapeArgs = {x: p, y: w, width: r, height: s}
        })
        ...
        p(a.points, function (h) {
            ...
            if (i !== r && !isNaN(i) && h.y !== null)f = h.shapeArgs, i = t(a.borderWidth) ? {"stroke-width": a.borderWidth} : {}, g = h.pointAttr[h.selected ?
        ...
        if (da)a ? (e.scaleY = 0.001, a = A(b.pos + b.len, v(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX" : "translateY"] = b.pos, this.group.animate(e,
    ...
    B.column = Ca;
    W.bar = x(W.column);
    va = ha(Ca, {type: "bar", inverted: !0});
    B.bar = va;
    W.scatter = x(E, {lineWidth: 0, tooltip: {headerFormat: '<span style="color:{series.color}">●</span> <span style="font-size: 10px;"> {series.name}</span><br/>', pointFormat: "x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>"}, stickyTracking: !1});
    va = ha(L, {type: "scatter", sorted: !1, requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["markerGroup", "dataLabelsGroup"], takeOrdinalPosition: !1, singularTooltips: !0, drawGraph: function () {
        this.options.lineWidth && L.prototype.drawGraph.call(this)
    }});
    B.scatter = va;
    W.pie = x(E, {borderColor: "#FFFFFF", borderWidth: 1, center: [null, null], clip: !1, colorByPoint: !0, dataLabels: {distance: 30, enabled: !0, formatter: function () {
    ...
    E = {type: "pie", isCartesian: !1, pointClass: ha(Ba, {init: function () {
        ...
        d.options.data[ya(this, d.data)] = this.options;
        ...
        this.generatePoints();
        var b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, f, g, h, i = c.startAngle || 0, j = this.startAngleRad = ta / 180 * (i - 90), i = (this.endAngleRad = ta / 180 * (q(c.endAngle, i + 360) - 90)) - j, k = this.points, l = c.dataLabels.distance, c = c.ignoreHiddenPoint, m, n = k.length, o;
        if (!a)this.center = a = this.getCenter();
        this.getX = function (b, c) {
            h = X.asin(A((b - a[1]) / (a[2] / 2 + l), 1));
            return a[0] + (c ? -1 : 1) * ea(h) * (a[2] / 2 + l)
        };
        for (m = 0; m <
            n; m++) {
            o = k[m];
            ...
            g = j + b * i;
            o.shapeType = "arc";
            o.shapeArgs = {x: a[0], y: a[1], r: a[2] / 2, innerR: a[3] / 2, start: u(f * 1E3) / 1E3, end: u(g * 1E3) / 1E3};
            h = (g + f) / 2;
            h > 1.5 * ta ? h -= 2 * ta : h < -ta / 2 && (h += 2 * ta);
            o.slicedTranslation = {translateX: u(ea(h) * d), translateY: u(ja(h) * d)};
            f = ea(h) * a[2] / 2;
            g = ja(h) * a[2] / 2;
            ...
            o.angle = h;
            e = A(e, l / 2);
            o.labelPos = [a[0] + f + ea(h) * l, a[1] + g + ja(h) * l, a[0] + f + ea(h) * e, a[1] + g + ja(h) * e, a[0] + f, a[1] + g, l < 0 ? "center" : o.half ?
                "right" : "left", h]
        }
        ...
        p(a.points, function (h) {
            ...
            f && f.attr(c);
            d ? d.animate(s(g, c)) : h.graphic = d = b[h.shapeType](g).setRadialReference(a.center).attr(h.pointAttr[h.selected ? "select" : ""]).attr({"stroke-linejoin": "round"}).attr(c).add(a.group).shadow(e,
                f);
    ...
    }, drawLegendSymbol: T.drawRectangle, getCenter: fa.getCenter, getSymbol: pa};
    E = ha(L, E);
    B.pie = E;
    L.prototype.drawDataLabels = function () {
        ...
        if (d.enabled || a._hasPointLabels)a.dlProcessOptions && a.dlProcessOptions(d), i = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), !a.hasRendered &&
            q(d.defer, !0) && (i.attr({opacity: 0}), z(a, "afterAnimate", function () {
            a.visible && i.show();
            i[b.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200})
        })), g = d, p(e, function (b) {
            var e, l = b.dataLabel, m, n, o = b.connector, p = !0;
            ...
            if (l && !e)b.dataLabel = l.destroy(); else if (e) {
                ...
                e = d.rotation;
                m = b.getLabelConfig();
                h = d.format ? La(d.format, m) : d.formatter.call(m, d);
                d.style.color = q(d.color, d.style.color, a.color, "black");
                if (l)if (t(h))l.attr({text: h}), p = !1; else {
                    if (b.dataLabel =
                    ...
                    l = b.dataLabel = a.chart.renderer[e ? "text" : "label"](h, 0, -999, null, null, null, d.useHTML).attr(l).css(s(d.style, c && {cursor: c})).add(i).shadow(d.shadow)
                }
                l && a.alignDataLabel(b, l, d, null, p)
            }
        })
    };
    L.prototype.alignDataLabel = function (a, b, c, d, e) {
        var f = this.chart, g = f.inverted, h = q(a.plotX, -999),
            i = q(a.plotY, -999), j = b.getBBox();
    ...
    L.prototype.justifyDataLabel = function (a, b, c, d, e, f) {
    ...
    if (B.pie)B.pie.prototype.drawDataLabels =
        function () {
            var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = q(e.connectorPadding, 10), g = q(e.connectorWidth, 1), h = d.plotWidth, i = d.plotHeight, j, k, l = q(e.softConnector, !0), m = e.distance, n = a.center, o = n[2] / 2, y = n[1], r = m > 0, s, w, t, x = [
                [],
                []
            ], z, O, D, G, C, R = [0, 0, 0, 0], H = function (a, b) {
                return b.y - a.y
            };
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                L.prototype.drawDataLabels.apply(a);
                p(b, function (a) {
                    a.dataLabel && a.visible && x[a.half].push(a)
                });
                for (G = 2; G--;) {
                    var B = [], K = [], F = x[G], J = F.length, E;
                    if (J) {
                        a.sortByAngle(F,
                            G - 0.5);
                        for (C = b = 0; !b && F[C];)b = F[C] && F[C].dataLabel && (F[C].dataLabel.getBBox().height || 21), C++;
                        if (m > 0) {
                            w = A(y + o + m, d.plotHeight);
                            for (C = v(0, y - o - m); C <= w; C += b)B.push(C);
                            w = B.length;
                            if (J > w) {
                                c = [].concat(F);
                                c.sort(H);
                                for (C = J; C--;)c[C].rank = C;
                                for (C = J; C--;)F[C].rank >= w && F.splice(C, 1);
                                J = F.length
                            }
                            for (C = 0; C < J; C++) {
                                c = F[C];
                                ...
                                c = 9999;
                                var N, M;
                                for (M = 0; M < w; M++)N = P(B[M] - t[1]), N < c && (c = N, E = M);
                                if (E < C && B[C] !== null)E = C; else for (w < J - C + E && B[C] !== null && (E = w - J + C); B[E] === null;)E++;
                                K.push({i: E, y: B[E]});
                                B[E] = null
                            }
                            K.sort(H)
                        ...
                        for (C =
                            ...
                            c = t[1];
                            if (m > 0) {
                                if (w = K.pop(), E = w.i, O = w.y, c > O && B[E + 1] !== null || c < O && B[E - 1] !== null)O = A(v(0, c), d.plotHeight)
                            } else O = c;
                            z = e.justify ? n[0] + (G ? -1 : 1) * (o + m) : a.getX(O === y - o - m || O === y + o + m ? c : O, G);
                            s._attr = {visibility: D, align: t[6]};
                            s._pos = {x: z + e.x + ({left: f, right: -f}[t[6]] || 0), y: O + e.y - 10};
                            s.connX = z;
                            s.connY = O;
                            if (this.options.size === null)w = s.width, z - w < f ? R[3] = v(u(w - z + f), R[3]) : z + w > h - f && (R[1] = v(u(z + w - h + f), R[1])), O - b / 2 < 0 ? R[0] = v(u(-O + b / 2), R[0]) :
                ...
                if (Da(R) === 0 || this.verifyDataLabelOverflow(R))this.placeDataLabels(), r && g && p(this.points, function (b) {
                    j = b.connector;
                    t = b.labelPos;
                    if ((s = b.dataLabel) && s._pos)D = s._attr.visibility, z = s.connX, O = s.connY, k = l ? ["M", z + (t[6] === "left" ? 5 : -5), O, "C", z, O, 2 * t[2] - t[4], 2 * t[3] - t[5], t[2], t[3], "L", t[4], t[5]] : ["M", z + (t[6] === "left" ? 5 : -5), O, "L", t[2], t[3], "L", t[4], t[5]], j ? (j.animate({d: k}), j.attr("visibility", D)) : b.connector = j = a.chart.renderer.path(k).attr({"stroke-width": g, stroke: e.connectorColor ||
                        b.color || "#606060", visibility: D}).add(a.dataLabelsGroup); else if (j)b.connector = j.destroy()
                })
            }
    ...
    }, B.pie.prototype.alignDataLabel = pa, B.pie.prototype.verifyDataLabelOverflow = function (a) {
        var b = this.center, c = this.options, d = c.center, e = c = c.minSize || 80, f;
        d[0] !== null ? e = v(b[2] - v(a[1], a[3]), c) : (e = v(b[2] - a[1] - a[3], c), b[0] += (a[3] -
            a[1]) / 2);
    ...
    if (B.column)B.column.prototype.alignDataLabel = function (a, b, c, d, e) {
        var f = this.chart, g = f.inverted, h = a.dlBox || a.shapeArgs, i = a.below || a.plotY > q(this.translatedThreshold, f.plotSizeY), j = q(c.inside, !!this.options.stacking);
        if (h && (d = x(h), g && (d = {x: f.plotWidth -
        ...
        L.prototype.alignDataLabel.call(this, a, b, c, d, e)
    };
    var ib = Q.TrackerMixin = {drawTrackerPoint: function () {
        var a = this, b = a.chart, c = b.pointer, d = a.options.cursor, e = d && {cursor: d}, f = function (c) {
            var d = c.target, e;
            if (b.hoverSeries !== a)a.onMouseOver();
            for (; d && !e;)e =
                d.point, d = d.parentNode;
        ...
        var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath), e =
            d.length, f = a.chart, g = f.pointer, h = f.renderer, i = f.options.tooltip.snap, j = a.tracker, k = b.cursor, l = k && {cursor: k}, k = a.singlePoints, m, n = function () {
        ...
        j ? j.attr({d: d}) : (a.tracker = h.path(d).attr({"stroke-linejoin": "round",
            visibility: a.visible ? "visible" : "hidden", stroke: o, fill: c ? o : $, "stroke-width": b.lineWidth + (c ? 0 : 2 * i), zIndex: 2}).add(a.group), p([a.tracker, a.markerGroup], function (a) {
    ...
    if (B.column)Ca.prototype.drawTracker = ib.drawTrackerPoint;
    if (B.pie)B.pie.prototype.drawTracker = ib.drawTrackerPoint;
    if (B.scatter)va.prototype.drawTracker = ib.drawTrackerPoint;
    s(rb.prototype, {setItemEvents: function (a, b, c, d, e) {
        var f = this;
    ...
    s(xa.prototype, {showResetZoom: function () {
        ...
        if (d && !e)this.showResetZoom(); else if (!d && ga(e))this.resetZoomButton = e.destroy();
        b && this.redraw(q(this.options.chart.animation, a && a.animation, this.pointCount <
            100))
    }, pan: function (a, b) {
        ...
        p(b === "xy" ? [1, 0] : [1], function (b) {
            ...
            h.series.length && l > A(k.dataMin, k.min) && i < v(k.dataMax, k.max) && (h.setExtremes(l, i, !1, !1, {trigger: "pan"}), e = !0);
            c[b ? "mouseDownX" : "mouseDownY"] = d
        });
        e && c.redraw(!1);
        K(c.container, {cursor: "move"})
    }});
    s(Ba.prototype, {select: function (a, b) {
        var c = this, d = c.series, e = d.chart, a = q(a, !c.selected);
        c.firePointEvent(a ? "select" : "unselect", {accumulate: b}, function () {
            c.selected = c.options.selected = a;
            d.options.data[ya(c, d.data)] = c.options;
            c.setState(a && "select");
            b || p(e.getSelectedPoints(), function (a) {
                if (a.selected && a !== c)a.selected = a.options.selected = !1, d.options.data[ya(a, d.data)] = a.options, a.setState(""), a.firePointEvent("unselect")
            })
        })
        ...
        if (!b || ya(this, b) === -1)this.setState(), a.hoverPoint = null
        ...
        if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (j || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
            if (this.graphic)g = g && this.graphic.symbolName && o.r, this.graphic.attr(x(o, g ? {x: c - g,
                y: d - g, width: 2 * g, height: 2 * g} : {})), k && k.hide(); else {
            ...
            if ((c = f[a] && f[a].halo) && c.size) {
                ...
                n.attr(s({fill: Ha(this.color || e.color).setOpacity(c.opacity).get()}, c.attributes))[b ?
    ...
    s(L.prototype, {onMouseOver: function () {
    ...
    M(J.prototype, "getTimeTicks", function (a, b, c, d, e, f, g, h) {
        var i = 0, j = 0, k, l = {}, m, n, o, p = [], q = -Number.MAX_VALUE, s = this.options.tickPixelInterval;
        ...
        if (h && a.unitRange <= H.hour) {
            j = p.length - 1;
            for (i = 1; i < j; i++)(new Date(p[i] -
                Na))[Wa]() !== (new Date(p[i - 1] - Na))[Wa]() && (l[p[i]] = "day", m = !0);
            m && (l[p[0]] = "day");
            a.higherRanks = l
        }
        p.info = a;
        if (h && t(s)) {
            ...
            m < s * 0.6 && (m = null);
            h = p[a - 1] > d ? a - 1 : a;
            for (w = void 0; h--;)i = j[h], d = w - i, w && d < s * 0.8 && (m === null || d < m * 0.8) ? (l[p[h]] && !l[p[h + 1]] ? (d = h + 1, w = i) : d = h, p.splice(d, 1)) : w = i
        }
        return p
    });
    s(J.prototype, {beforeSetTickPositions: function () {
        ...
        if (this.options.ordinal) {
            ...
            c ? (this.ordinalPositions = b, c = this.val2lin(v(f, b[0]), !0), d = this.val2lin(A(e, b[b.length - 1]), !0), this.ordinalSlope = e = (e - f) / (d - c), this.ordinalOffset =
        ...
        if (c) {
            ...
            if (b)a < 0 ? a = c[0] : a > f ? a = c[f] : (f = V(a),
                h = a - f); else for (; f--;)if (g = d * f + e, a >= g) {
                d = d * (f + 1) + e;
                h = (a - g) / (d - g);
                break
            }
        ...
        if (!c[d])f = {series: [], getExtremes: function () {
            return{min: e.dataMin, max: e.dataMax}
        }, options: {ordinal: !0}, val2lin: J.prototype.val2lin}, p(this.series, function (c) {
            g = {xAxis: f, xData: c.xData,
                chart: a, destroyGroupedData: pa};
            g.options = {dataGrouping: b ? {enabled: !0, forced: !0, approximation: "open", units: [
                [b.unitName, [b.count]]
            ]} : {enabled: !1}};
    ...
    M(xa.prototype, "pan", function (a, b) {
        ...
        if (c.options.ordinal && c.series.length) {
            var f = this.mouseDownX, g = c.getExtremes(), h = g.dataMax, i = g.min, j = g.max, k = this.hoverPoints, l = c.closestPointRange, f = (f - d) / (c.translationSlope * (c.ordinalSlope || l)), m = {ordinalPositions: c.getExtendedPositions()}, l = c.lin2val, n = c.val2lin, o;
            if (m.ordinalPositions) {
                if (P(f) > 1)k &&
                    p(k, function (a) {
                        a.setState()
                    }), f < 0 ? (k = m, o = c.ordinalPositions ? c : m) : (k = c.ordinalPositions ? c : m, o = m), m = o.ordinalPositions, h > m[m.length - 1] && m.push(h), this.fixedRange = j - i, f = c.toFixedRange(null, null, l.apply(k, [n.apply(k, [i, !0]) + f, !0]), l.apply(o, [n.apply(o, [j, !0]) + f, !0])), f.min >= A(g.dataMin, i) && f.max <= v(h, j) && c.setExtremes(f.min, f.max, !0, !1, {trigger: "pan"}), this.mouseDownX = d, K(this.container, {cursor: "move"})
            } else e = !0
        } else e = !0;
    ...
    var ca = L.prototype, E = Ib.prototype, gc = ca.processData, hc = ca.generatePoints, ic = ca.destroy, jc = E.tooltipHeaderFormatter, kc = {approximation: "average", groupPixelWidth: 2, dateTimeLabelFormats: {millisecond: ["%A, %b %e, %H:%M:%S.%L", "%A, %b %e, %H:%M:%S.%L",
        ...
        columnrange: {approximation: "range", groupPixelWidth: 10}, candlestick: {approximation: "ohlc", groupPixelWidth: 10}, ohlc: {approximation: "ohlc", groupPixelWidth: 5}}, Wb = [
        ["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]],
        ["second", [1, 2, 5, 10, 15, 30]],
        ["minute", [1, 2, 5, 10, 15, 30]],
        ["hour", [1, 2, 3, 4, 6, 8, 12]],
        ...
        return a.length ? Da(a) : a.hasNulls ? null : r
    }, low: function (a) {
        return a.length ? Ta(a) : a.hasNulls ? null : r
    }, close: function (a) {
    ...
    ca.groupData = function (a, b, c, d) {
        var e = this.data, f = this.options.data, g = [], h = [], i = a.length, j, k, l = !!b, m = [
            [],
            [],
            [],
            []
        ], d = typeof d === "function" ? d : Pa[d], n = this.pointArrayMap, o = n && n.length, p;
        for (p = 0; p <= i; p++)if (a[p] >= c[0])break;
        for (; p <= i; p++) {
            for (; c[1] !== r && a[p] >= c[1] || p === i;)if (j = c.shift(), k = d.apply(0, m), k !== r && (g.push(j), h.push(k)), m[0] = [], m[1] = [], m[2] = [], m[3] = [], p === i)break;
            if (p === i)break;
            if (n) {
                j = this.cropStart + p;
                j = e && e[j] || this.pointClass.prototype.applyOptions.apply({series: this},
                    [f[j]]);
                var q;
                for (k = 0; k < o; k++)if (q = j[n[k]], typeof q === "number")m[k].push(q); else if (q === null)m[k].hasNulls = !0
    ...
    ca.processData = function () {
        ...
        if (gc.apply(this, arguments) !== !1 && d) {
            ...
            var f = this.processedXData, g = this.processedYData,
                h = a.plotSizeX, a = this.xAxis, i = a.options.ordinal, j = this.groupPixelWidth = a.getGroupPixelWidth && a.getGroupPixelWidth(), d = this.pointRange;
            if (j) {
                e = !0;
                this.points = null;
                var k = a.getExtremes(), d = k.min, k = k.max, i = i && a.getGroupIntervalFactor(d, k, this) || 1, h = j * (k - d) / h * i, j = a.getTimeTicks(a.normalizeTimeTickInterval(h, c.units || Wb), d, k, null, f, this.closestPointRange), g = ca.groupData.apply(this, [f, g, j, c.approximation]), f = g[0], g = g[1];
                if (c.smoothed) {
                    c = f.length - 1;
    ...
    ca.generatePoints = function () {
        hc.apply(this);
        this.destroyGroupedData();
        this.groupedData = this.hasGroupedData ?
            this.points : null
    };
    E.tooltipHeaderFormatter = function (a) {
        ...
        if (g && g.options.type === "datetime" && d && ma(a.key)) {
            b = b.currentDataGrouping;
            d = d.dateTimeLabelFormats;
            if (b)g = d[b.unitName], b.count === 1 ? e = g[0] : (e = g[1], f = g[2]); else if (!e && d)for (h in H)if (H[h] >= g.closestPointRange || H[h] <= H.day && a.key % H[h] > 0) {
                e = d[h][0];
                break
            }
            e = wa(e, a.key);
            f && (e += wa(f, a.key + b.totalRange - 1));
    ...
    M(ca, "setOptions", function (a, b) {
        var c = a.call(this, b), d = this.type, e = this.chart.options.plotOptions, f = W[d].dataGrouping;
        if (Vb[d])f || (f = x(kc, Vb[d])), c.dataGrouping = x(f, e.series && e.series.dataGrouping, e[d].dataGrouping, b.dataGrouping);
        if (this.chart.options._stock)this.requireSorting = !0;
        return c
    });
    M(J.prototype, "setScale", function (a) {
        a.call(this);
        p(this.series, function (a) {
            a.hasProcessed = !1
        })
    ...
    W.ohlc = x(W.column, {lineWidth: 1, tooltip: {pointFormat: '<span style="color:{series.color}">●</span> <b> {series.name}</b><br/>Open: {point.open}<br/>High: {point.high}<br/>Low: {point.low}<br/>Close: {point.close}<br/>'},
        states: {hover: {lineWidth: 3}}, threshold: null});
    E = ha(B.column, {type: "ohlc", pointArrayMap: ["open", "high", "low", "close"], toYData: function (a) {
    ...
    B.ohlc = E;
    W.candlestick = x(W.column, {lineColor: "#74E05E", lineWidth: 1, states: {hover: {lineWidth: 2, upColor: "#74E05E"}}, tooltip: W.ohlc.tooltip, threshold: null, upColor: "#36A845"});
    E = ha(E, {type: "candlestick", pointAttrToOptions: {fill: "color", stroke: "#FFAD7D", "stroke-width": "lineWidth"},
        upColorProp: "fill", getAttribs: function () {
            ...
            p(a.points, function (p) {
                m = p.graphic;
                if (p.plotY !== r)c = p.pointAttr[p.selected ? "selected" : ""] ||
    ...
    B.candlestick = E;
    var sb = la.prototype.symbols;
    W.flags = x(W.column, {fillColor: "white", lineWidth: 1, pointRange: 0, shape: "flag", stackDistance: 12,
    ...
    B.flags = ha(B.column, {type: "flags", sorted: !1, noSharedTooltip: !0, allowDG: !1, takeOrdinalPosition: !1, trackerGroups: ["markerGroup"], forceCrop: !0, init: L.prototype.init, pointAttrToOptions: {fill: "fillColor", stroke: "color", "stroke-width": "lineWidth", r: "radius"}, translate: function () {
        B.column.prototype.translate.apply(this);
        var a =
            this.chart, b = this.points, c = b.length - 1, d, e, f = this.options.onSeries, f = (d = f && a.get(f)) && d.options.step, g = d && d.points, h = g && g.length, i = this.xAxis, j = i.getExtremes(), k, l, m;
        if (d && d.visible && h) {
        ...
        p(b, function (c, d) {
            if (c.plotY === r)c.x >=
                j.min && c.x <= j.max ? c.plotY = a.chartHeight - i.bottom - (i.opposite ? i.height : 0) + i.offset - a.plotTop : c.shapeArgs = {};
        ...
        for (j = c.length; j--;)if (k = c[j], a = k.plotX > this.xAxis.len, e = k.plotX + (a ? m : -m), l = k.stackIndex, i = k.options.shape || g.shape, f = k.plotY, f !== r && (f = k.plotY + h + m - (l !==
    ...
    Ya === Q.VMLRenderer && p(["flag", "circlepin", "squarepin"], function (a) {
        hb.prototype.symbols[a] = sb[a]
    });
    var E = [].concat(Wb), tb = function (a) {
        return Math[a].apply(0, pb(arguments, function (a) {
            return typeof a === "number"
        }))
    };
    E[4] = ["day", [1, 2, 3, 4]];
    E[5] = ["week", [1, 2, 3]];
    s(F, {navigator: {handles: {backgroundColor: "#ebe7e8", borderColor: "#b2b1b6"}, height: 40, margin: 25, maskFill: "rgba(128,179,236,0.3)", maskInside: !0, outlineColor: "#b2b1b6", outlineWidth: 1, series: {type: B.areaspline === r ? "line" :
    ...
    Bb.prototype = {drawHandle: function (a, b) {
        var c =
            this.chart, d = c.renderer, e = this.elementsToDestroy, f = this.handles, g = this.navigatorOptions.handles, g = {fill: g.backgroundColor, stroke: g.borderColor, "stroke-width": 1}, h;
        this.rendered || (f[b] = d.g("navigator-handle-" + ["left", "right"][b]).css({cursor: "e-resize"}).attr({zIndex: 4 - b}).add(), h = d.rect(-4.5, 0, 9, 16, 0, 1).attr(g).add(f[b]), e.push(h), h = d.path(["M", -1.5, 4, "L", -1.5, 12, "M", 0.5, 4, "L", 0.5, 12]).attr(g).add(f[b]), e.push(h));
        f[b][c.isResizing ? "animate" : "attr"]({translateX: this.scrollerLeft + this.scrollbarHeight +
        ...
        this.rendered || (d[a] = b.g().add(this.scrollbarGroup), g = b.rect(-0.5, -0.5, e + 1, e + 1, f.buttonBorderRadius, f.buttonBorderWidth).attr({stroke: f.buttonBorderColor, "stroke-width": f.buttonBorderWidth, fill: f.buttonBackgroundColor}).add(d[a]), c.push(g), g = b.path(["M", e / 2 + (a ? -1 : 1), e / 2 - 3, "L", e / 2 + (a ? -1 : 1), e /
            2 + 3, e / 2 + (a ? 2 : -2), e / 2]).attr({fill: f.buttonArrowColor}).add(d[a]), c.push(g));
        ...
        if (!isNaN(a)) {
            ...
            if (!(l.translate(d, !0) - l.translate(c, !0) < e.xAxis[0].minRange)) {
                ...
                this.zoomedMin = v(this.fixedWidth ?
                    this.zoomedMax - this.fixedWidth : A(c, d), 0);
                ...
                if (!this.rendered) {
                    if (z) {
                        this.navigatorGroup = l = f.g("navigator").attr({zIndex: 3}).add();
                        this.leftShade = f.rect().attr({fill: r.maskFill}).add(l);
                        if (!r.maskInside)this.rightShade = f.rect().attr({fill: r.maskFill}).add(l);
                        this.outline = f.path().attr({"stroke-width": O, stroke: r.outlineColor}).add(l)
                    }
                    if (p)this.scrollbarGroup = k = f.g("scrollbar").add(), m = s.trackBorderWidth, this.scrollbarTrack =
                ...
                if (z) {
                    this.leftShade[e](r.maskInside ? {x: g + b, y: x, width: c - b, height: t} : {x: g, y: x, width: b, height: t});
                    if (this.rightShade)this.rightShade[e]({x: g +
                        c, y: x, width: h - c, height: t});
                    this.outline[e]({d: ["M", i, E, "L", g + b + B, E, g + b + B, E + C, "L", g + c - B, E + C, "L", g + c - B, E, i + j, E].concat(r.maskInside ? ["M", g + b + B, E, "L", g + c - B, E] : [])});
                    this.drawHandle(b + B, 0);
                    this.drawHandle(c + B, 1)
                }
                if (p && k)this.drawScrollbarButton(0), this.drawScrollbarButton(1), k[e]({translateX: i, translateY: u(E + t)}), n[e]({width: j}), g = o + b, h = a - F, h < w && (D = (w - h) / 2, h = w, g -= D), this.scrollbarPad = D, m[e]({x: V(g) + F % 2 / 2, width: h}), w = o + b + a / 2 - 0.5, this.scrollbarRifles.attr({visibility: a > 12 ? "visible" : "hidden"})[e]({d: ["M",
        ...
        a.mouseDownHandler = function (d) {
            var d = b.pointer.normalize(d), e = a.zoomedMin, f = a.zoomedMax, h = a.top, j = a.scrollbarHeight, m = a.scrollerLeft, n = a.scrollerWidth, o = a.navigatorLeft, p = a.navigatorWidth, q = a.scrollbarPad, r = a.range, s = d.chartX, t = d.chartY, d = b.xAxis[0], u, v = eb ?
                10 : 7;
            if (t > h && t < h + g + j)if ((h = !a.scrollbarEnabled || t < h + g) && X.abs(s - e - o) < v)a.grabbedLeft = !0, a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null; else if (h && X.abs(s - f - o) < v)a.grabbedRight = !0, a.otherHandlePos = e, a.fixedExtreme = d.min, b.fixedRange = null; else if (s > o + e - q && s < o + f + q) {
                a.grabbedCenter = s;
                a.fixedWidth = r;
                ...
                if (f < 0)f = 0; else if (f + r >= p)f = p - r, u = c.dataMax;
                if (f !== e)a.fixedWidth =
        ...
        a.mouseMoveHandler = function (c) {
            ...
            if (c.pageX !== 0)c = b.pointer.normalize(c), l = c.chartX, l < e ? l = e : l > g + h - d && (l = g + h - d), a.grabbedLeft ? (j = !0, a.render(0, 0, l - e, a.otherHandlePos)) : a.grabbedRight ? (j = !0, a.render(0, 0, a.otherHandlePos, l - e)) : a.grabbedCenter && (j = !0, l < i ? l = i : l > f + i - k && (l = f + i - k), a.render(0, 0, l - i, l - i + k)), j && a.scrollbarOptions.liveRedraw &&
                setTimeout(function () {
                    a.mouseUpHandler(c)
                }, 0)
        };
        ...
        M(b, "getMargins", function (b) {
            ...
            a.top = h = a.navigatorOptions.top || this.chartHeight - a.height - a.scrollbarHeight - this.spacing[2] - (f.verticalAlign ===
                "bottom" && f.enabled && !f.floating ? e.legendHeight + q(f.margin, 10) : 0);
        ...
        if (!a || b.dataMin !== null)return{dataMin: tb("min", d && d.min, e.min, b.dataMin, c.dataMin), dataMax: tb("max", d && d.max, e.max, b.dataMax, c.dataMax)}
        ...
        b = x(b, d, {enableMouseTracking: !1, group: "nav", padXAxis: !1, xAxis: "navigator-x-axis", yAxis: "navigator-y-axis", name: "Navigator", showInLegend: !1, isInternal: !0, visible: !0});
        b.data = e || c;
        this.series = this.chart.initSeries(b);
        if (a && this.navigatorOptions.adaptToUpdatedData !== !1)z(a,
        ...
        p([this.scrollbarButtons,
            this.handles, this.elementsToDestroy], function (a) {
            Ma(a)
        })
    }};
    Q.Scroller = Bb;
    M(J.prototype, "zoom", function (a, b, c) {
        var d = this.chart, e = d.options, f = e.chart.zoomType, g = e.navigator, e = e.rangeSelector, h;
        if (this.isXAxis && (g && g.enabled || e && e.enabled))if (f === "x")d.resetZoomButton = "blocked"; else if (f === "y")h = !1; else if (f === "xy")d = this.previousZoom, t(b) ? this.previousZoom = [this.min, this.max] : d && (b = d[0], c = d[1], delete this.previousZoom);
        return h !== r ? h : a.call(this, b, c)
    });
    M(xa.prototype, "init", function (a, b, c) {
        z(this,
            "beforeRender", function () {
                var a = this.options;
                if (a.navigator.enabled || a.scrollbar.enabled)this.scroller = new Bb(this)
            });
        a.call(this, b, c)
    });
    M(L.prototype, "addPoint", function (a, b, c, d, e) {
        var f = this.options.turboThreshold;
        f && this.xData.length > f && ga(b) && !Ra(b) && this.chart.scroller && oa(20, !0);
        a.call(this, b, c, d, e)
    });
    s(F, {rangeSelector: {buttonTheme: {width: 28, height: 18, fill: "#f7f7f7", padding: 2, r: 0, "stroke-width": 0, style: {color: "#444", cursor: "pointer", fontWeight: "normal"}, zIndex: 7, states: {hover: {fill: "#e7e7e7"},
        select: {fill: "#e7f0f9", style: {color: "black", fontWeight: "bold"}}}}, inputPosition: {align: "right"}, labelStyle: {color: "#666"}}});
    F.lang = x(F.lang, {rangeSelectorZoom: "Zoom", rangeSelectorFrom: "From", rangeSelectorTo: "To"});
    Cb.prototype = {clickButton: function (a, b) {
        var c = this, d = c.selected, e = c.chart, f = c.buttons, g = c.buttonOptions[a], h = e.xAxis[0], i = e.scroller && e.scroller.getUnionExtremes() || h || {}, j = i.dataMin, k = i.dataMax, l, m = h && u(A(h.max, q(k, h.max))), n = new Date(m), o = g.type, s = g.count, i = g._range, t;
        if (!(j === null ||
            k === null || a === c.selected)) {
            if (o === "month" || o === "year")l = {month: "Month", year: "FullYear"}[o], n["set" + l](n["get" + l]() - s), l = n.getTime(), j = q(j, Number.MIN_VALUE), isNaN(l) || l < j ? (l = j, m = A(l + i, k)) : i = m - l; else if (i)l = v(m - i, j), m = A(l + i, k); else if (o === "ytd")if (h) {
            ...
            f[a] && f[a].setState(2);
            e.fixedRange = i;
            h ? h.setExtremes(l, m, q(b, 1), 0, {trigger: "rangeSelectorButton", rangeSelectorButton: g}) : (d = e.options.xAxis, d[0] = x(d[0], {range: i, min: t}));
            c.setSelected(a)
        }
        ...
        init: function (a) {
            ...
            p(b.buttonOptions, function (a, c) {
                var e = a._range, n = e > g - f, o = e < d.minRange, p = a.type === "all" && d.max - d.min >= g - f && j[c].state !== 2, q = a.type === "ytd" && wa("%Y", f) === wa("%Y", g);
                e === u(d.max - d.min) && c !== h ? (b.setSelected(c), j[c].setState(2)) : !i && (n || o || p || q) ? j[c].setState(3) : j[c].state ===
                    3 && j[c].setState(0)
            })
        }, computeButtonRange: function (a) {
            var b = a.type, c = a.count || 1, d = {millisecond: 1, second: 1E3, minute: 6E4, hour: 36E5, day: 864E5, week: 6048E5};
            if (d[b])a._range = d[b] * c; else if (b === "month" || b === "year")a._range = {month: 30, year: 365}[b] * 864E5 * c
        }, setInputValue: function (a, b) {
            var c = this.chart.options.rangeSelector;
            if (t(b))this[a + "Input"].HCTime = b;
            this[a + "Input"].value = wa(c.inputEditDateFormat || "%Y-%m-%d", this[a + "Input"].HCTime);
            this[a + "DateBox"].attr({text: wa(c.inputDateFormat || "%b %e, %Y", this[a +
                "Input"].HCTime)})
            ...
            this[a + "Label"] = j = e.label(F.lang[h ? "rangeSelectorFrom" : "rangeSelectorTo"], this.inputGroup.offset).attr({padding: 2}).css(x(d, f.labelStyle)).add(l);
            l.offset += j.width + 5;
            this[a + "DateBox"] = k = e.label("", l.offset).attr({padding: 2, width: f.inputBoxWidth || 90, height: f.inputBoxHeight || 17, stroke: f.inputBoxBorderColor || "silver", "stroke-width": 1}).css(x({textAlign: "center",
                color: "#444"}, d, f.inputStyle)).on("click",function () {
                b[a + "Input"].focus()
            }).add(l);
            l.offset += k.width + (h ? 10 : 0);
            this[a + "Input"] = i = aa("input", {name: a, className: "highcharts-range-selector", type: "text"}, s({position: "absolute", border: 0, width: "1px", height: "1px", padding: 0, textAlign: "center", fontSize: d.fontSize, fontFamily: d.fontFamily, top: c.plotTop + "px"}, f.inputStyle), g);
            i.onfocus = function () {
                K(this, {left: l.translateX + k.x + "px", top: l.translateY + "px", width: k.width - 2 + "px", height: k.height - 2 + "px", border: "2px solid silver"})
            };
            i.onblur = function () {
                K(this, {border: 0, width: "1px", height: "1px"});
                b.setInputValue(a)
            };
            i.onchange = function () {
            ...
            if (!c.rendered && (c.zoomText = e.text(g.rangeSelectorZoom, o, d.plotTop - 20).css(i.labelStyle).add(), r = o + c.zoomText.getBBox().width + 5, p(c.buttonOptions, function (a, b) {
                j[b] = e.button(a.text, r, d.plotTop - 35,function () {
                    ...
                    n.select).css({textAlign: "center"}).add();
                r += j[b].width + q(i.buttonSpacing, 5);
                c.selected === b && j[b].setState(2)
            }), c.updateButtonStates(), m))c.div = k = aa("div", null, {position: "relative", height: 0, zIndex: 1}), f.parentNode.insertBefore(k, f), c.inputGroup = k = e.g("input-group").add(), k.offset = 0, c.drawInput("min"), c.drawInput("max");
            m && (f = d.plotTop - 45, k.align(s({y: f, width: k.offset, x: h && f < (h.y || 0) + h.height - d.spacing[0] ? -40 : 0}, i.inputPosition), !0, d.spacingBox), c.setInputValue("min", a), c.setInputValue("max", b));
            c.rendered = !0
        }, destroy: function () {
            ...
            for (e in this)this[e] && e !== "chart" && (this[e].destroy ? this[e].destroy() : this[e].nodeType && Ua(this[e])), this[e] = null
        }};
    ...
    Q.RangeSelector = Cb;
    xa.prototype.callbacks.push(function (a) {
        function b() {
        ...
        g && (z(a.xAxis[0], "afterSetExtremes", d), M(a, "drawChartBox", function (a) {
            var c = this.isDirtyBox;
            a.call(this);
            c && b()
        }), b());
        h && (z(a.xAxis[0], "afterSetExtremes", e), z(a, "resize", c), c());
        z(a, "destroy", function () {
    ...
    Q.StockChart = function (a, b) {
        ...
        a.xAxis = za(na(a.xAxis || {}), function (a) {
            return x({minPadding: 0, maxPadding: 0, ordinal: !0, title: {text: null}, labels: {overflow: "justify"}, showLastLabel: !0}, a, {type: "datetime", categories: null}, e)
        });
        a.yAxis = za(na(a.yAxis || {}), function (a) {
            d = q(a.opposite, !0);
            return x({labels: {y: -2}, opposite: d, showLastLabel: !1, title: {text: null}}, a)
        });
        a.series = null;
        a = x({chart: {panning: !0, pinchType: "x"}, navigator: {enabled: !0}, scrollbar: {enabled: !0}, rangeSelector: {enabled: !0}, title: {text: null, style: {fontSize: "16px"}},
            tooltip: {shared: !0, crosshairs: !0}, legend: {enabled: !1}, plotOptions: {line: f, spline: f, area: f, areaspline: f, arearange: f, areasplinerange: f, column: g, columnrange: g, candlestick: g, ohlc: g}}, a, {_stock: !0, chart: {inverted: !1}});
        a.series = c;
        return new xa(a, b)
    };
    M(Za.prototype, "init", function (a, b, c) {
    ...
    M(J.prototype, "autoLabelAlign",
        function (a) {
            if (this.chart.options._stock && this.coll === "yAxis" && ya(this, this.chart.yAxis) === 0) {
                if (this.options.labels.x === 15)this.options.labels.x = 0;
                return"right"
            }
            return a.call(this, [].slice.call(arguments, 1))
        });
    J.prototype.getPlotLinePath = function (a, b, c, d, e) {
        ...
        s = f.isXAxis ? t(f.options.yAxis) ? [h.yAxis[f.options.yAxis]] : za(g, function (a) {
            return a.yAxis
        }) : t(f.options.xAxis) ?
            [h.xAxis[f.options.xAxis]] : za(g, function (a) {
            return a.xAxis
        });
        p(f.isXAxis ? h.yAxis : h.xAxis, function (a) {
            if (t(a.options.id) ? a.options.id.indexOf("navigator") === -1 : 1) {
                var b = a.isXAxis ? "yAxis" : "xAxis", b = t(a.options[b]) ? h[b][a.options[b]] : h[b][0];
                f === b && s.push(a)
            }
        });
        v = s.length ? [] : [f];
    ...
    la.prototype.crispPolyLine = function (a, b) {
        var c;
        for (c = 0; c < a.length; c += 6)a[c + 1] === a[c + 4] && (a[c + 1] = a[c + 4] = u(a[c + 1]) - b % 2 / 2), a[c + 2] === a[c + 5] && (a[c +
            2] = a[c + 5] = u(a[c + 2]) + b % 2 / 2);
        return a
    };
    if (Ya === Q.VMLRenderer)hb.prototype.crispPolyLine = la.prototype.crispPolyLine;
    M(J.prototype, "hideCrosshair", function (a, b) {
        a.call(this, b);
        t(this.crossLabelArray) && (t(b) ? this.crossLabelArray[b] && this.crossLabelArray[b].hide() : p(this.crossLabelArray, function (a) {
            a.hide()
        }))
    });
    M(J.prototype, "drawCrosshair", function (a, b, c) {
        var d, e;
        a.call(this, b, c);
        if (t(this.crosshair.label) && this.crosshair.label.enabled && t(c)) {
            var a = this.chart, f = this.options.crosshair.label, g = this.isXAxis ?
                "x" : "y", b = this.horiz, h = this.opposite, i = this.left, j = this.top, k = this.crossLabel, l, m, n = f.format, o = "";
            if (!k)k = this.crossLabel = a.renderer.label().attr({align: f.align || (b ? "center" : h ? this.labelAlign === "right" ? "right" : "left" : this.labelAlign === "left" ? "left" : "center"), zIndex: 12, height: b ? 16 : r, fill: f.backgroundColor || this.series[0] && this.series[0].color || "gray", padding: q(f.padding, 2), stroke: f.borderColor || null, "stroke-width": f.borderWidth || 0}).css(s({color: "white", fontWeight: "normal", fontSize: "11px", textAlign: "center"},
                f.style)).add();
            ...
            if (m < j || m > j + this.height)this.hideCrosshair(); else {
                ...
                k.attr({text: n ? La(n, {value: c[g]}) : f.formatter.call(this, c[g]), x: l, y: m, visibility: "visible"});
                c = k.getBBox();
                if (b) {
                    if (this.options.tickPosition === "inside" && !h || this.options.tickPosition !== "inside" && h)m = k.y - c.height
                } else m = k.y - c.height / 2;
                b ? (d = i - c.x, e = i + this.width - c.x) : (d = this.labelAlign ===
                    "left" ? i : 0, e = this.labelAlign === "right" ? i + this.width : a.chartWidth);
    ...
    Ba.prototype.tooltipFormatter = function (a) {
        a = a.replace("{point.change}", (this.change > 0 ? "+" : "") + Ka(this.change, q(this.series.tooltipOptions.changeDecimals, 2)));
        return nc.apply(this, [a])
    };
    M(L.prototype, "render", function (a) {
        if (this.chart.options._stock)!this.clipBox && this.animate && this.animate.toString().indexOf("sharedClip") !== -1 ? (this.clipBox = x(this.chart.clipBox), this.clipBox.width = this.xAxis.len,
            this.clipBox.height = this.yAxis.len) : this.chart[this.sharedClipKey] && this.chart[this.sharedClipKey].attr({width: this.xAxis.len, height: this.yAxis.len});
        a.call(this)
    });
    s(Q, {Axis: J, Chart: xa, Color: Ha, Point: Ba, Tick: ab, Renderer: Ya, Series: L, SVGElement: Z, SVGRenderer: la, arrayMin: Ta, arrayMax: Da, charts: ba, dateFormat: wa, format: La, pathAnim: Fb, getOptions: function () {
        return F
    }, hasBidiBug: Xb, isTouchDevice: eb, numberFormat: Ka, seriesTypes: B, setOptions: function (a) {
        F = x(!0, F, a);
        Lb();
        return F
    }, addEvent: z, removeEvent: U, createElement: aa,
